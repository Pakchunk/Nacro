...
{
public:
	struct FChatColorScheme                            ChatColorData;                                            // 0x0028(0x0120) (Edit)
...
{
public:
	struct FButtonStyle                                Style;                                                    // 0x0028(0x02A8) (Edit)
...
{
public:
	struct FChatChromeColorScheme                      Style;                                                    // 0x0028(0x0050) (Edit)
...
{
public:
	struct FChatChromeMargins                          Style;                                                    // 0x0028(0x0064) (Edit)
...
{
public:
	struct FChatChromeStyle                            Style;                                                    // 0x0028(0x0850) (Edit)
...
{
public:
	struct FChatMarkupStyle                            Style;                                                    // 0x0028(0x0670) (Edit)
...
{
public:
	struct FChatStyle                                  Style;                                                    // 0x0028(0x1490) (Edit)
...
{
public:
	struct FCheckBoxStyle                              Style;                                                    // 0x0028(0x05E0) (Edit)
...
{
public:
	struct FSocialFontStyle                            Style;                                                    // 0x0028(0x02A0) (Edit)
...
{
public:
	struct FSocialListMargins                          Style;                                                    // 0x0028(0x0200) (Edit)
...
{
public:
	struct FSocialListStyle                            Style;                                                    // 0x0028(0x2870) (Edit)
...
{
public:
	struct FScrollBarStyle                             Style;                                                    // 0x0028(0x0518) (Edit)
...
{
public:
	struct FSocialSoundSchema                          SoundSchema;                                              // 0x0028(0x0048) (Edit)
...
{
public:
	class USocialFontStyleDataAsset*                   SmallFontStyle;                                           // 0x0028(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialFontStyleDataAsset*                   NormalFontStyle;                                          // 0x0030(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialFontStyleDataAsset*                   LargeFontStyle;                                           // 0x0038(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialFontStyleDataAsset*                   ChatFontStyle;                                            // 0x0040(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialListStyleDataAsset*                   SocialListStyle;                                          // 0x0048(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialListMarginsDataAsset*                 SocialListMargins;                                        // 0x0050(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialChatStyleDataAsset*                   ChatStyle;                                                // 0x0058(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialChatChromeStyleDataAsset*             ChatChromeStyle;                                          // 0x0060(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialChatChromeMarginsDataAsset*           ChatChromeMargins;                                        // 0x0068(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialChatChromeColorSchemeDataAsset*       ChatChromeColorScheme;                                    // 0x0070(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UChatColorSchemeDataAsset*                   ChatColorScheme;                                          // 0x0078(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialSoundSchemaDataAsset*                 SoundSchema;                                              // 0x0080(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialActionButtonStyleDataAsset*           ActionButtonStyle;                                        // 0x0088(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialCheckBoxStyleDataAsset*               CheckBoxStyle;                                            // 0x0090(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialRadioBoxStyleDataAsset*               RadioBoxStyle;                                            // 0x0098(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialScrollBarStyleDataAsset*              ScrollBoxStyle;                                           // 0x00A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialChatMarkupStyleDataAsset*             MarkupStyle;                                              // 0x00A8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialProfanityDataAsset*                   ProfanityDataAsset;                                       // 0x00B0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
