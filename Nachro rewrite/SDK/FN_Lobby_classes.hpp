...
{
public:
	class ALobbyBeaconPlayerState*                     PlayerState;                                              // 0x0440(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0448(0x0001) MISSED OFFSET
	ELobbyBeaconJoinState                              LobbyJoinServerState;                                     // 0x0449(0x0001) (ZeroConstructor, IsPlainOldData)
