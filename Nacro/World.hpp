...
namespace World
{
	...
	// Spawn a new actor. Returns spawned actor.
	...
	// Place all loaded items into the global weapons map, and equip it for faster future equipping.
	...
	{
		// This is a weird way of formatting it, but it's basically just setting a property on an object at a certain offset from the GameState
