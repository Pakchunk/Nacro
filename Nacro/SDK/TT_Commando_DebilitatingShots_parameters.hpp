...
// 0x58CA4D10 (0x58CA4D10 - 0x0000)
struct alignas(0x58CA4D10) TT_Commando_DebilitatingShots_C_GetTextForTokenFromAbilityInstanceInternal final
{
public:
	const class UGameplayAbility*                 AbilityInstance;                                   // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(TT_Commando_DebilitatingShots_C_GetTextForTokenFromAbilityInstanceInternal) == 0x58CA4D10, "Wrong alignment on TT_Commando_DebilitatingShots_C_GetTextForTokenFromAbilityInstanceInternal");
static_assert(sizeof(TT_Commando_DebilitatingShots_C_GetTextForTokenFromAbilityInstanceInternal) == 0x58CA4D10, "Wrong size on TT_Commando_DebilitatingShots_C_GetTextForTokenFromAbilityInstanceInternal");
...
static_assert(alignof(TT_Commando_DebilitatingShots_C_BP_GetTokenizedDescriptionText) == 0x11821D80, "Wrong alignment on TT_Commando_DebilitatingShots_C_BP_GetTokenizedDescriptionText");
static_assert(sizeof(TT_Commando_DebilitatingShots_C_BP_GetTokenizedDescriptionText) == 0x11821D80, "Wrong size on TT_Commando_DebilitatingShots_C_BP_GetTokenizedDescriptionText");
