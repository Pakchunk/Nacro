...
public:
	...
	class UImage*                                 mImage__HR;                                        // 0x0238(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTextBlock*                             mText__Label;                                      // 0x0240(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTextBlock*                             mText__Single;                                     // 0x0248(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTextBlock*                             mText__Value;                                      // 0x0250(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UTooltipStatWidget_C, mImage__HR) == 0x000238, "Member 'UTooltipStatWidget_C::mImage__HR' has a wrong offset!");
static_assert(offsetof(UTooltipStatWidget_C, mText__Label) == 0x000240, "Member 'UTooltipStatWidget_C::mText__Label' has a wrong offset!");
static_assert(offsetof(UTooltipStatWidget_C, mText__Single) == 0x000248, "Member 'UTooltipStatWidget_C::mText__Single' has a wrong offset!");
static_assert(offsetof(UTooltipStatWidget_C, mText__Value) == 0x000250, "Member 'UTooltipStatWidget_C::mText__Value' has a wrong offset!");
