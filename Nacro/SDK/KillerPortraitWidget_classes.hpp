...
static_assert(alignof(UKillerPortraitWidget_C) == 0x322CBBB8, "Wrong alignment on UKillerPortraitWidget_C");
static_assert(sizeof(UKillerPortraitWidget_C) == 0x322CBBB8, "Wrong size on UKillerPortraitWidget_C");
