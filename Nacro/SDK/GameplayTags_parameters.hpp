...
static_assert(alignof(BlueprintGameplayTagLibrary_AddGameplayTagToContainer) == 0x000008, "Wrong alignment on BlueprintGameplayTagLibrary_AddGameplayTagToContainer");
static_assert(sizeof(BlueprintGameplayTagLibrary_AddGameplayTagToContainer) == 0x000030, "Wrong size on BlueprintGameplayTagLibrary_AddGameplayTagToContainer");
