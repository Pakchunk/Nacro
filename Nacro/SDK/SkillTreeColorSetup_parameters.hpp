...
{
public:
	struct FSkillTreePageColors                   Page_Color;                                        // 0x0000(0x11821300)(Parm, HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_Select_Default;                             // 0x00DC(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           K2Node_Select2_Default;                            // 0x00EC(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_Select3_Default;                            // 0x0100(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(SkillTreeColorSetup_C_SkillTreeBGSetup) == 0x11821300, "Wrong alignment on SkillTreeColorSetup_C_SkillTreeBGSetup");
static_assert(sizeof(SkillTreeColorSetup_C_SkillTreeBGSetup) == 0x11821300, "Wrong size on SkillTreeColorSetup_C_SkillTreeBGSetup");
