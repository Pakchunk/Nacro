...
public:
	...
	struct FVector                                DrainLocationOffset;                               // 0x0480(0x11821300)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                TargetLocation;                                    // 0x048C(0x11821300)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(AGCN_RiftStaminaDrain_C) == 0x11821D80, "Wrong alignment on AGCN_RiftStaminaDrain_C");
static_assert(sizeof(AGCN_RiftStaminaDrain_C) == 0x11821D80, "Wrong size on AGCN_RiftStaminaDrain_C");
