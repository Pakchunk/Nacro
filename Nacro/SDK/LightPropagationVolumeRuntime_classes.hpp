...
public:
	...
	struct FLightPropagationVolumeSettings        Settings;                                          // 0x0030(0x11821C00)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(ULightPropagationVolumeBlendable) == 0x11821C00, "Wrong alignment on ULightPropagationVolumeBlendable");
static_assert(sizeof(ULightPropagationVolumeBlendable) == 0x11821C00, "Wrong size on ULightPropagationVolumeBlendable");
