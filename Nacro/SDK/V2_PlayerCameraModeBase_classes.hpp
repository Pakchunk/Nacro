...
static_assert(alignof(UV2_PlayerCameraModeBase_C) == 0x11821D80, "Wrong alignment on UV2_PlayerCameraModeBase_C");
static_assert(sizeof(UV2_PlayerCameraModeBase_C) == 0x11821D80, "Wrong size on UV2_PlayerCameraModeBase_C");
