...
struct alignas(0x11822800) FProfileUpdateSingle
{
public:
	...
	struct FDateTime                              LockExpiration;                                    // 0x0030(0x11821300)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
#pragma pack(pop)
static_assert(alignof(FProfileUpdateSingle) == 0x11822800, "Wrong alignment on FProfileUpdateSingle");
static_assert(sizeof(FProfileUpdateSingle) == 0x11822800, "Wrong size on FProfileUpdateSingle");
...
public:
	...
	struct FDateTime                              ServerTime;                                        // 0x0058(0x11821300)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FProfileUpdate) == 0x11822800, "Wrong alignment on FProfileUpdate");
static_assert(sizeof(FProfileUpdate) == 0x11822800, "Wrong size on FProfileUpdate");
...
public:
	...
	struct FJsonObjectWrapper                     Attributes;                                        // 0x0028(0x11821780)(NativeAccessSpecifierPublic)
	class FString                                 ItemProfile;                                       // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMcpLootEntry) == 0x11821780, "Wrong alignment on FMcpLootEntry");
static_assert(sizeof(FMcpLootEntry) == 0x11821780, "Wrong size on FMcpLootEntry");
...
// 0x1182B380 (0x1182B380 - 0x0000)
struct alignas(0x1182B380) FMcpLootResult final
{
public:
...
static_assert(alignof(FMcpLootResult) == 0x1182B380, "Wrong alignment on FMcpLootResult");
static_assert(sizeof(FMcpLootResult) == 0x1182B380, "Wrong size on FMcpLootResult");
...
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FProfileUpdateNotification final
{
public:
	TArray<struct FJsonObjectWrapper>             Changes;                                           // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FDateTime                              LockExpiration;                                    // 0x0010(0x11821300)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FProfileUpdateNotification) == 0x11822800, "Wrong alignment on FProfileUpdateNotification");
static_assert(sizeof(FProfileUpdateNotification) == 0x11822800, "Wrong size on FProfileUpdateNotification");
...
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FProfileEntry final
{
public:
...
static_assert(alignof(FProfileEntry) == 0x11822800, "Wrong alignment on FProfileEntry");
static_assert(sizeof(FProfileEntry) == 0x11822800, "Wrong size on FProfileEntry");
...
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FProfileHttpRequest final
{
public:
...
static_assert(alignof(FProfileHttpRequest) == 0x11822800, "Wrong alignment on FProfileHttpRequest");
static_assert(sizeof(FProfileHttpRequest) == 0x11822800, "Wrong size on FProfileHttpRequest");
...
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FBaseUrlContext
{
public:
	uint8                                         Pad_0[0x70];                                       // 0x0000(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBaseUrlContext) == 0x11822800, "Wrong alignment on FBaseUrlContext");
static_assert(sizeof(FBaseUrlContext) == 0x11822800, "Wrong size on FBaseUrlContext");
...
static_assert(alignof(FPublicUrlContext) == 0x11822800, "Wrong alignment on FPublicUrlContext");
static_assert(sizeof(FPublicUrlContext) == 0x11822800, "Wrong size on FPublicUrlContext");
...
static_assert(alignof(FClientUrlContext) == 0x11822800, "Wrong alignment on FClientUrlContext");
static_assert(sizeof(FClientUrlContext) == 0x11822800, "Wrong size on FClientUrlContext");
...
static_assert(alignof(FDedicatedServerUrlContext) == 0x11822800, "Wrong alignment on FDedicatedServerUrlContext");
static_assert(sizeof(FDedicatedServerUrlContext) == 0x11822800, "Wrong size on FDedicatedServerUrlContext");

// ScriptStruct McpProfileSys.ProfileGroupEntry
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FProfileGroupEntry final
{
public:
...
static_assert(alignof(FProfileGroupEntry) == 0x11822800, "Wrong alignment on FProfileGroupEntry");
static_assert(sizeof(FProfileGroupEntry) == 0x11822800, "Wrong size on FProfileGroupEntry");
...
struct alignas(0x33DB3A00) FMcpAddItemRequest final
{
public:
...
static_assert(alignof(FMcpAddItemRequest) == 0x33DB3A00, "Wrong alignment on FMcpAddItemRequest");
static_assert(sizeof(FMcpAddItemRequest) == 0x33DB3A00, "Wrong size on FMcpAddItemRequest");
...
// 0x33DB3A00 (0x33DB3A00 - 0x0000)
struct alignas(0x33DB3A00) FMcpRemoveItemRequest final
{
public:
	class FString                                 ItemId;                                            // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMcpRemoveItemRequest) == 0x33DB3A00, "Wrong alignment on FMcpRemoveItemRequest");
static_assert(sizeof(FMcpRemoveItemRequest) == 0x33DB3A00, "Wrong size on FMcpRemoveItemRequest");
...
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FMcpChangeQuantityRequest final
{
public:
	class FString                                 ItemId;                                            // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FMcpChangeQuantityRequest) == 0x11822800, "Wrong alignment on FMcpChangeQuantityRequest");
static_assert(sizeof(FMcpChangeQuantityRequest) == 0x11822800, "Wrong size on FMcpChangeQuantityRequest");
...
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FMcpChangeAttributesRequest final
{
public:
	class FString                                 ItemId;                                            // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FJsonObjectWrapper                     Attributes;                                        // 0x0010(0x11821780)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FMcpChangeAttributesRequest) == 0x11822800, "Wrong alignment on FMcpChangeAttributesRequest");
static_assert(sizeof(FMcpChangeAttributesRequest) == 0x11822800, "Wrong size on FMcpChangeAttributesRequest");
...
// 0x11822800 (0x11822800 - 0x0000)
struct alignas(0x11822800) FMcpProfileChangeRequest final
{
public:
...
static_assert(alignof(FMcpProfileChangeRequest) == 0x11822800, "Wrong alignment on FMcpProfileChangeRequest");
static_assert(sizeof(FMcpProfileChangeRequest) == 0x11822800, "Wrong size on FMcpProfileChangeRequest");
