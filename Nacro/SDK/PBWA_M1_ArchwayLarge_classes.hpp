...
static_assert(alignof(APBWA_M1_ArchwayLarge_C) == 0x000010, "Wrong alignment on APBWA_M1_ArchwayLarge_C");
static_assert(sizeof(APBWA_M1_ArchwayLarge_C) == 0x0010B0, "Wrong size on APBWA_M1_ArchwayLarge_C");
