...
static_assert(alignof(UBP_ItemTransform_TabButton_C) == 0x322CBBB8, "Wrong alignment on UBP_ItemTransform_TabButton_C");
static_assert(sizeof(UBP_ItemTransform_TabButton_C) == 0x322CBBB8, "Wrong size on UBP_ItemTransform_TabButton_C");
