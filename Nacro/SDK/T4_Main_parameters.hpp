...
struct alignas(0x74) T4_Main_C_ExecuteUbergraph_T4_Main final
{
public:
...
static_assert(alignof(T4_Main_C_ExecuteUbergraph_T4_Main) == 0x000074, "Wrong alignment on T4_Main_C_ExecuteUbergraph_T4_Main");
static_assert(sizeof(T4_Main_C_ExecuteUbergraph_T4_Main) == 0x000074, "Wrong size on T4_Main_C_ExecuteUbergraph_T4_Main");
