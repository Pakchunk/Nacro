...
public:
	...
	struct FFortTeamMemberInfo                    CallFunc_Array_Get_Item;                           // 0x0070(0x11827900)()
...
static_assert(alignof(TeamMicStack_C_ExecuteUbergraph_TeamMicStack) == 0x11821780, "Wrong alignment on TeamMicStack_C_ExecuteUbergraph_TeamMicStack");
static_assert(sizeof(TeamMicStack_C_ExecuteUbergraph_TeamMicStack) == 0x11821780, "Wrong size on TeamMicStack_C_ExecuteUbergraph_TeamMicStack");
...
public:
	...
	class UCinematicMinusTeamMics_C*              CallFunc_Array_Get_Item;                           // 0x01A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(TeamMicStack_C_HandleTeamMemberChanged) == 0x11821780, "Wrong alignment on TeamMicStack_C_HandleTeamMemberChanged");
static_assert(sizeof(TeamMicStack_C_HandleTeamMemberChanged) == 0x11821780, "Wrong size on TeamMicStack_C_HandleTeamMemberChanged");
...
public:
	...
	TArray<class UHUDMinusTeamMemberInfo_C*>      K2Node_MakeArray_Array;                            // 0x01A0(0x0010)(ZeroConstructor, ReferenceParm)
	...
	class UCinematicMinusTeamMics_C*              CallFunc_Create_ReturnValue;                       // 0x01D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FMargin                                K2Node_MakeStruct_Margin;                          // 0x01D8(0x322CBBB8)(NoDestructor)
...
static_assert(alignof(TeamMicStack_C_ShiftTeamMembers) == 0x322CBBB8, "Wrong alignment on TeamMicStack_C_ShiftTeamMembers");
static_assert(sizeof(TeamMicStack_C_ShiftTeamMembers) == 0x322CBBB8, "Wrong size on TeamMicStack_C_ShiftTeamMembers");
...
public:
	...
	class UCinematicMinusTeamMics_C*              CallFunc_Create_ReturnValue;                       // 0x01B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(TeamMicStack_C_AppendTeamMember) == 0x322CBBB8, "Wrong alignment on TeamMicStack_C_AppendTeamMember");
static_assert(sizeof(TeamMicStack_C_AppendTeamMember) == 0x322CBBB8, "Wrong size on TeamMicStack_C_AppendTeamMember");
