...
static_assert(alignof(ULeaderboardHeaderRowWidget_C) == 0x322CBBB8, "Wrong alignment on ULeaderboardHeaderRowWidget_C");
static_assert(sizeof(ULeaderboardHeaderRowWidget_C) == 0x322CBBB8, "Wrong size on ULeaderboardHeaderRowWidget_C");
