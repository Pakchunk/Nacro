...
struct alignas(0x3F000000) ProgressModalWidget_C_ExecuteUbergraph_ProgressModalWidget final
{
public:
...
static_assert(alignof(ProgressModalWidget_C_ExecuteUbergraph_ProgressModalWidget) == 0x3F000000, "Wrong alignment on ProgressModalWidget_C_ExecuteUbergraph_ProgressModalWidget");
static_assert(sizeof(ProgressModalWidget_C_ExecuteUbergraph_ProgressModalWidget) == 0x3F000000, "Wrong size on ProgressModalWidget_C_ExecuteUbergraph_ProgressModalWidget");
...
{
public:
	struct FSlateBrush                            Icon_0;                                            // 0x0000(0x322CBBB8)(Parm)
};
static_assert(alignof(ProgressModalWidget_C_SetIcon) == 0x11827900, "Wrong alignment on ProgressModalWidget_C_SetIcon");
static_assert(sizeof(ProgressModalWidget_C_SetIcon) == 0x11827900, "Wrong size on ProgressModalWidget_C_SetIcon");
...
public:
	...
	struct FAnalogInputEvent                      InAnalogInputEvent;                                // 0x0038(0x11827900)(Parm)
	struct FEventReply                            ReturnValue;                                       // 0x0080(0x11827900)(Parm, OutParm, ReturnParm)
	struct FEventReply                            CallFunc_Unhandled_ReturnValue;                    // 0x0138(0x11827900)()
	struct FEventReply                            CallFunc_Handled_ReturnValue;                      // 0x01F0(0x11827900)()
};
static_assert(alignof(ProgressModalWidget_C_OnAnalogValueChanged) == 0x11827900, "Wrong alignment on ProgressModalWidget_C_OnAnalogValueChanged");
static_assert(sizeof(ProgressModalWidget_C_OnAnalogValueChanged) == 0x11827900, "Wrong size on ProgressModalWidget_C_OnAnalogValueChanged");
