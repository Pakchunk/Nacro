...
static_assert(alignof(UV1_PlayerCameraModeRanged_C) == 0x11821D80, "Wrong alignment on UV1_PlayerCameraModeRanged_C");
static_assert(sizeof(UV1_PlayerCameraModeRanged_C) == 0x11821D80, "Wrong size on UV1_PlayerCameraModeRanged_C");
