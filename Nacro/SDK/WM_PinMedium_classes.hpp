...
static_assert(alignof(AWM_PinMedium_C) == 0x11821D80, "Wrong alignment on AWM_PinMedium_C");
static_assert(sizeof(AWM_PinMedium_C) == 0x11821D80, "Wrong size on AWM_PinMedium_C");
