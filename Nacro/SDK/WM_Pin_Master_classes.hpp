...
public:
	...
	class UPointLightComponent*                   PointLightMinusBMinusLock;                         // 0x03B8(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UPointLightComponent*                   PointLightMinusAMinusLock;                         // 0x03C0(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class UPointLightComponent*                   PointLightMinusBMinusPin;                          // 0x03D0(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UPointLightComponent*                   PointLightMinusAMinusPin;                          // 0x03D8(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           IdleHover1;                                        // 0x0418(0x11821300)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           IdleHover2;                                        // 0x0428(0x11821300)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           GlowColor;                                         // 0x0438(0x11821300)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           DifficultyColor;                                   // 0x0448(0x11821300)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UMaterialInstanceDynamic*               MIDMinusPing;                                      // 0x0498(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*               MIDMinusDiffGlow;                                  // 0x04A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*               MIDMinusPin;                                       // 0x04A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*               MIDMinusLocked;                                    // 0x04B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(AWM_Pin_Master_C) == 0x11821D80, "Wrong alignment on AWM_Pin_Master_C");
static_assert(sizeof(AWM_Pin_Master_C) == 0x11821D80, "Wrong size on AWM_Pin_Master_C");
...
static_assert(offsetof(AWM_Pin_Master_C, PointLightMinusBMinusLock) == 0x0003B8, "Member 'AWM_Pin_Master_C::PointLightMinusBMinusLock' has a wrong offset!");
static_assert(offsetof(AWM_Pin_Master_C, PointLightMinusAMinusLock) == 0x0003C0, "Member 'AWM_Pin_Master_C::PointLightMinusAMinusLock' has a wrong offset!");
static_assert(offsetof(AWM_Pin_Master_C, PinLocked) == 0x0003C8, "Member 'AWM_Pin_Master_C::PinLocked' has a wrong offset!");
static_assert(offsetof(AWM_Pin_Master_C, PointLightMinusBMinusPin) == 0x0003D0, "Member 'AWM_Pin_Master_C::PointLightMinusBMinusPin' has a wrong offset!");
static_assert(offsetof(AWM_Pin_Master_C, PointLightMinusAMinusPin) == 0x0003D8, "Member 'AWM_Pin_Master_C::PointLightMinusAMinusPin' has a wrong offset!");
...
static_assert(offsetof(AWM_Pin_Master_C, MIDMinusPing) == 0x000498, "Member 'AWM_Pin_Master_C::MIDMinusPing' has a wrong offset!");
static_assert(offsetof(AWM_Pin_Master_C, MIDMinusDiffGlow) == 0x0004A0, "Member 'AWM_Pin_Master_C::MIDMinusDiffGlow' has a wrong offset!");
static_assert(offsetof(AWM_Pin_Master_C, MIDMinusPin) == 0x0004A8, "Member 'AWM_Pin_Master_C::MIDMinusPin' has a wrong offset!");
static_assert(offsetof(AWM_Pin_Master_C, MIDMinusLocked) == 0x0004B0, "Member 'AWM_Pin_Master_C::MIDMinusLocked' has a wrong offset!");
