...
struct alignas(0x1182B500) FActorSequenceObjectReference final
{
public:
	...
	struct FGuid                                  ActorId;                                           // 0x0004(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FString                                 PathToComponent;                                   // 0x0018(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FActorSequenceObjectReference) == 0x1182B500, "Wrong alignment on FActorSequenceObjectReference");
static_assert(sizeof(FActorSequenceObjectReference) == 0x1182B500, "Wrong size on FActorSequenceObjectReference");
...
// 0x1182B500 (0x1182B500 - 0x0000)
struct alignas(0x1182B500) FActorSequenceObjectReferences final
{
public:
	TArray<struct FActorSequenceObjectReference>  Array;                                             // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FActorSequenceObjectReferences) == 0x1182B500, "Wrong alignment on FActorSequenceObjectReferences");
static_assert(sizeof(FActorSequenceObjectReferences) == 0x1182B500, "Wrong size on FActorSequenceObjectReferences");
...
struct alignas(0x1182B200) FActorSequenceObjectReferenceMap final
{
public:
...
static_assert(alignof(FActorSequenceObjectReferenceMap) == 0x1182B200, "Wrong alignment on FActorSequenceObjectReferenceMap");
static_assert(sizeof(FActorSequenceObjectReferenceMap) == 0x1182B200, "Wrong size on FActorSequenceObjectReferenceMap");
