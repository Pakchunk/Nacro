...
static_assert(alignof(USetBonus_MaxShield_High_C) == 0x1182E980, "Wrong alignment on USetBonus_MaxShield_High_C");
static_assert(sizeof(USetBonus_MaxShield_High_C) == 0x1182E980, "Wrong size on USetBonus_MaxShield_High_C");
