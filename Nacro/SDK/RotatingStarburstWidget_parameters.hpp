...
static_assert(alignof(RotatingStarburstWidget_C_ExecuteUbergraph_RotatingStarburstWidget) == 0x11827900, "Wrong alignment on RotatingStarburstWidget_C_ExecuteUbergraph_RotatingStarburstWidget");
static_assert(sizeof(RotatingStarburstWidget_C_ExecuteUbergraph_RotatingStarburstWidget) == 0x11827900, "Wrong size on RotatingStarburstWidget_C_ExecuteUbergraph_RotatingStarburstWidget");
...
static_assert(alignof(RotatingStarburstWidget_C_Tick) == 0x11827900, "Wrong alignment on RotatingStarburstWidget_C_Tick");
static_assert(sizeof(RotatingStarburstWidget_C_Tick) == 0x11827900, "Wrong size on RotatingStarburstWidget_C_Tick");
