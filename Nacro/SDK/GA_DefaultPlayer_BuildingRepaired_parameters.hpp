...
public:
	...
	struct FGameplayAbilityTargetDataHandle       CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x00B0(0x11821C00)()
...
static_assert(alignof(GA_DefaultPlayer_BuildingRepaired_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingRepaired) == 0x11822200, "Wrong alignment on GA_DefaultPlayer_BuildingRepaired_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingRepaired");
static_assert(sizeof(GA_DefaultPlayer_BuildingRepaired_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingRepaired) == 0x11822200, "Wrong size on GA_DefaultPlayer_BuildingRepaired_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingRepaired");
...
static_assert(alignof(GA_DefaultPlayer_BuildingRepaired_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GA_DefaultPlayer_BuildingRepaired_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GA_DefaultPlayer_BuildingRepaired_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GA_DefaultPlayer_BuildingRepaired_C_K2_ActivateAbilityFromEvent");
