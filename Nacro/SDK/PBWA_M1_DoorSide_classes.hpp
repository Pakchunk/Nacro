...
static_assert(alignof(APBWA_M1_DoorSide_C) == 0x1182A000, "Wrong alignment on APBWA_M1_DoorSide_C");
static_assert(sizeof(APBWA_M1_DoorSide_C) == 0x1182A000, "Wrong size on APBWA_M1_DoorSide_C");
