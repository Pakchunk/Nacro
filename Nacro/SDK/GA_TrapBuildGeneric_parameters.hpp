...
struct alignas(0xE4) GA_TrapBuildGeneric_C_ExecuteUbergraph_GA_TrapBuildGeneric final
{
public:
...
static_assert(alignof(GA_TrapBuildGeneric_C_ExecuteUbergraph_GA_TrapBuildGeneric) == 0x0000E4, "Wrong alignment on GA_TrapBuildGeneric_C_ExecuteUbergraph_GA_TrapBuildGeneric");
static_assert(sizeof(GA_TrapBuildGeneric_C_ExecuteUbergraph_GA_TrapBuildGeneric) == 0x0000E4, "Wrong size on GA_TrapBuildGeneric_C_ExecuteUbergraph_GA_TrapBuildGeneric");
