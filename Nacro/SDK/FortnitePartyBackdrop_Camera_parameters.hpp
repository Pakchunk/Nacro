...
static_assert(sizeof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera) == 0x000028, "Wrong size on FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera");
...
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_GetTimeOfDayManagerFromContext_ReturnValue) == 0x000008, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_GetTimeOfDayManagerFromContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_GetAllActorsOfClass_OutActors) == 0x000010, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_GetAllActorsOfClass_OutActors' has a wrong offset!");
