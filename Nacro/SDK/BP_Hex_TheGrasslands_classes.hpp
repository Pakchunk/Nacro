...
static_assert(alignof(ABP_Hex_TheGrasslands_C) == 0x1182EB00, "Wrong alignment on ABP_Hex_TheGrasslands_C");
static_assert(sizeof(ABP_Hex_TheGrasslands_C) == 0x1182EB00, "Wrong size on ABP_Hex_TheGrasslands_C");
