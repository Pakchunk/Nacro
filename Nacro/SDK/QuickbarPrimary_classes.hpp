...
public:
	...
	struct FPointerToUberGraphFrame               UberGraphFrame_QuickbarPrimary_C;                  // 0x0288(0x11821D80)(Transient, DuplicateTransient)
...
static_assert(alignof(UQuickbarPrimary_C) == 0x322CBBB8, "Wrong alignment on UQuickbarPrimary_C");
static_assert(sizeof(UQuickbarPrimary_C) == 0x322CBBB8, "Wrong size on UQuickbarPrimary_C");
