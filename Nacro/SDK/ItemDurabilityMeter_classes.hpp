...
public:
	...
	struct FLinearColor                           Backfill_Color;                                    // 0x0258(0x11821300)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(UItemDurabilityMeter_C) == 0x322CBBB8, "Wrong alignment on UItemDurabilityMeter_C");
static_assert(sizeof(UItemDurabilityMeter_C) == 0x322CBBB8, "Wrong size on UItemDurabilityMeter_C");
