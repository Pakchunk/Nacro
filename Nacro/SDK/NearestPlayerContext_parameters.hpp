...
public:
	...
	struct FVector                                ResultingLocation;                                 // 0x0010(0x11821300)(Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                Location;                                          // 0x001C(0x11821300)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue2;         // 0x0044(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(NearestPlayerContext_C_ProvideSingleLocation) == 0x11821300, "Wrong alignment on NearestPlayerContext_C_ProvideSingleLocation");
static_assert(sizeof(NearestPlayerContext_C_ProvideSingleLocation) == 0x11821300, "Wrong size on NearestPlayerContext_C_ProvideSingleLocation");
