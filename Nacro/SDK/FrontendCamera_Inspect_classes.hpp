...
static_assert(sizeof(AFrontendCamera_Inspect_C) == 0x0008D0, "Wrong size on AFrontendCamera_Inspect_C");
static_assert(offsetof(AFrontendCamera_Inspect_C, UberGraphFrame) == 0x0008C0, "Member 'AFrontendCamera_Inspect_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AFrontendCamera_Inspect_C, LoginCamera_0) == 0x0008C8, "Member 'AFrontendCamera_Inspect_C::LoginCamera_0' has a wrong offset!");
