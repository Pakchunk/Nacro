...
public:
	...
	struct FVector2D                              Temp_struct_Variable;                              // 0x0008(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable2;                             // 0x0010(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable3;                             // 0x0018(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable4;                             // 0x0020(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable5;                             // 0x0028(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable6;                             // 0x0030(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              K2Node_Select_Default;                             // 0x0040(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateBrush                            K2Node_MakeStruct_SlateBrush;                      // 0x0048(0x322CBBB8)()
	ESlateVisibility                              K2Node_Select2_Default;                            // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget) == 0x11827900, "Wrong alignment on BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget");
static_assert(sizeof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget) == 0x11827900, "Wrong size on BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget");
...
struct alignas(0xE4) BasicRatingWidget_C_PreConstruct final
{
public:
	bool                                          IsDesignTime;                                      // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(BasicRatingWidget_C_PreConstruct) == 0x0000E4, "Wrong alignment on BasicRatingWidget_C_PreConstruct");
static_assert(sizeof(BasicRatingWidget_C_PreConstruct) == 0x0000E4, "Wrong size on BasicRatingWidget_C_PreConstruct");
...
{
public:
	struct FLinearColor                           Color1;                                            // 0x0000(0x11821300)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Color2;                                            // 0x0010(0x11821300)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(BasicRatingWidget_C_Update_Border_Color) == 0x11821300, "Wrong alignment on BasicRatingWidget_C_Update_Border_Color");
static_assert(sizeof(BasicRatingWidget_C_Update_Border_Color) == 0x11821300, "Wrong size on BasicRatingWidget_C_Update_Border_Color");
...
struct alignas(0x750048) BasicRatingWidget_C_Get_Current_Rating final
{
public:
	float                                         CurrentNumericValue;                               // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BasicRatingWidget_C_Get_Current_Rating) == 0x750048, "Wrong alignment on BasicRatingWidget_C_Get_Current_Rating");
static_assert(sizeof(BasicRatingWidget_C_Get_Current_Rating) == 0x750048, "Wrong size on BasicRatingWidget_C_Get_Current_Rating");
