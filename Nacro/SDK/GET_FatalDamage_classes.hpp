...
static_assert(alignof(UGET_FatalDamage_C) == 0x1182E980, "Wrong alignment on UGET_FatalDamage_C");
static_assert(sizeof(UGET_FatalDamage_C) == 0x1182E980, "Wrong size on UGET_FatalDamage_C");
