...
static_assert(alignof(UMissionFocusWidget_C) == 0x322CBBB8, "Wrong alignment on UMissionFocusWidget_C");
static_assert(sizeof(UMissionFocusWidget_C) == 0x322CBBB8, "Wrong size on UMissionFocusWidget_C");
