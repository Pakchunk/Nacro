...
static_assert(alignof(UAthenaSessionId_C) == 0x322CBBB8, "Wrong alignment on UAthenaSessionId_C");
static_assert(sizeof(UAthenaSessionId_C) == 0x322CBBB8, "Wrong size on UAthenaSessionId_C");
