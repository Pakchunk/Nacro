...
static_assert(alignof(UCircleAroundPrimaryAssignmentGoals_Bombshell_C) == 0x11821780, "Wrong alignment on UCircleAroundPrimaryAssignmentGoals_Bombshell_C");
static_assert(sizeof(UCircleAroundPrimaryAssignmentGoals_Bombshell_C) == 0x11821780, "Wrong size on UCircleAroundPrimaryAssignmentGoals_Bombshell_C");
