...
// 0x300054 (0x300054 - 0x0000)
struct alignas(0x300054) FItemTextureStylesheet final
{
public:
...
static_assert(alignof(FItemTextureStylesheet) == 0x300054, "Wrong alignment on FItemTextureStylesheet");
static_assert(sizeof(FItemTextureStylesheet) == 0x300054, "Wrong size on FItemTextureStylesheet");
