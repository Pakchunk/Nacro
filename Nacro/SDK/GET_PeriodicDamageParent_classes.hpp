...
static_assert(alignof(UGET_PeriodicDamageParent_C) == 0x1182E980, "Wrong alignment on UGET_PeriodicDamageParent_C");
static_assert(sizeof(UGET_PeriodicDamageParent_C) == 0x1182E980, "Wrong size on UGET_PeriodicDamageParent_C");
