...
// 0x02CB (0x02CB - 0x0000)
struct alignas(0x2CB) TT_Commando_AmmoRecovery1_C_InitializeAbilityInstanceInternal final
{
public:
...
static_assert(alignof(TT_Commando_AmmoRecovery1_C_InitializeAbilityInstanceInternal) == 0x0002CB, "Wrong alignment on TT_Commando_AmmoRecovery1_C_InitializeAbilityInstanceInternal");
static_assert(sizeof(TT_Commando_AmmoRecovery1_C_InitializeAbilityInstanceInternal) == 0x0002CB, "Wrong size on TT_Commando_AmmoRecovery1_C_InitializeAbilityInstanceInternal");
...
static_assert(alignof(TT_Commando_AmmoRecovery1_C_GetTextForTokenFromAbilityInstanceInternal) == 0x11821D80, "Wrong alignment on TT_Commando_AmmoRecovery1_C_GetTextForTokenFromAbilityInstanceInternal");
static_assert(sizeof(TT_Commando_AmmoRecovery1_C_GetTextForTokenFromAbilityInstanceInternal) == 0x11821D80, "Wrong size on TT_Commando_AmmoRecovery1_C_GetTextForTokenFromAbilityInstanceInternal");
