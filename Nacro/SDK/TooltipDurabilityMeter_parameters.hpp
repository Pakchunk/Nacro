...
// 0x7F2C (0x7F2C - 0x0000)
struct alignas(0x7F2C) TooltipDurabilityMeter_C_ExecuteUbergraph_TooltipDurabilityMeter final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(TooltipDurabilityMeter_C_ExecuteUbergraph_TooltipDurabilityMeter) == 0x007F2C, "Wrong alignment on TooltipDurabilityMeter_C_ExecuteUbergraph_TooltipDurabilityMeter");
static_assert(sizeof(TooltipDurabilityMeter_C_ExecuteUbergraph_TooltipDurabilityMeter) == 0x007F2C, "Wrong size on TooltipDurabilityMeter_C_ExecuteUbergraph_TooltipDurabilityMeter");
...
public:
	...
	struct FFortDisplayAttribute                  Display_Attribute;                                 // 0x0008(0x11821C00)(Parm)
...
static_assert(alignof(TooltipDurabilityMeter_C_Draw) == 0x11821C00, "Wrong alignment on TooltipDurabilityMeter_C_Draw");
static_assert(sizeof(TooltipDurabilityMeter_C_Draw) == 0x11821C00, "Wrong size on TooltipDurabilityMeter_C_Draw");
