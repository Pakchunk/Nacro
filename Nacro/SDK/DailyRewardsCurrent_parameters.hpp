...
public:
	...
	struct FVector2D                              Temp_struct_Variable;                              // 0x000C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable2;                             // 0x0014(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              K2Node_Select_Default;                             // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              K2Node_Select2_Default;                            // 0x0020(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(DailyRewardsCurrent_C_ExecuteUbergraph_DailyRewardsCurrent) == 0x11821300, "Wrong alignment on DailyRewardsCurrent_C_ExecuteUbergraph_DailyRewardsCurrent");
static_assert(sizeof(DailyRewardsCurrent_C_ExecuteUbergraph_DailyRewardsCurrent) == 0x11821300, "Wrong size on DailyRewardsCurrent_C_ExecuteUbergraph_DailyRewardsCurrent");
...
public:
	...
	struct FVector2D                              Temp_struct_Variable;                              // 0x0024(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              Temp_struct_Variable2;                             // 0x003C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable4;                               // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              K2Node_Select4_Default;                            // 0x0048(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortRarity                                   CallFunc_GetRarity_ReturnValue;                    // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortRarityItemData                    CallFunc_BPGetRarityData_ReturnValue;              // 0x0058(0x11821780)()
};
static_assert(alignof(DailyRewardsCurrent_C_Set_Item_Flare) == 0x11821780, "Wrong alignment on DailyRewardsCurrent_C_Set_Item_Flare");
static_assert(sizeof(DailyRewardsCurrent_C_Set_Item_Flare) == 0x11821780, "Wrong size on DailyRewardsCurrent_C_Set_Item_Flare");
