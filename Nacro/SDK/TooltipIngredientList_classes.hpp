...
static_assert(alignof(UTooltipIngredientList_C) == 0x322CBBB8, "Wrong alignment on UTooltipIngredientList_C");
static_assert(sizeof(UTooltipIngredientList_C) == 0x322CBBB8, "Wrong size on UTooltipIngredientList_C");
