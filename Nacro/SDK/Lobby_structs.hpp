...
// 0x0C00 (0x11822800 - 0x11821C00)
struct alignas(0x11822800) FLobbyPlayerStateActorInfo final : public FFastArraySerializerItem
{
public:
...
static_assert(alignof(FLobbyPlayerStateActorInfo) == 0x11822800, "Wrong alignment on FLobbyPlayerStateActorInfo");
static_assert(sizeof(FLobbyPlayerStateActorInfo) == 0x11822800, "Wrong size on FLobbyPlayerStateActorInfo");
...
// 0x0C00 (0x11822800 - 0x11821C00)
struct alignas(0x11822800) FLobbyPlayerStateInfoArray final : public FFastArraySerializer
{
public:
...
static_assert(alignof(FLobbyPlayerStateInfoArray) == 0x11822800, "Wrong alignment on FLobbyPlayerStateInfoArray");
static_assert(sizeof(FLobbyPlayerStateInfoArray) == 0x11822800, "Wrong size on FLobbyPlayerStateInfoArray");
