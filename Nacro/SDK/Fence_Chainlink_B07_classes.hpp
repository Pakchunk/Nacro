...
static_assert(alignof(AFence_Chainlink_B07_C) == 0x1182A000, "Wrong alignment on AFence_Chainlink_B07_C");
static_assert(sizeof(AFence_Chainlink_B07_C) == 0x1182A000, "Wrong size on AFence_Chainlink_B07_C");
