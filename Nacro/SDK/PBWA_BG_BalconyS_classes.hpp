...
static_assert(alignof(APBWA_BG_BalconyS_C) == 0x000010, "Wrong alignment on APBWA_BG_BalconyS_C");
static_assert(sizeof(APBWA_BG_BalconyS_C) == 0x000FD0, "Wrong size on APBWA_BG_BalconyS_C");
