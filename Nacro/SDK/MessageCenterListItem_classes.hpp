...
static_assert(alignof(UMessageCenterListItem_C) == 0x322CBBB8, "Wrong alignment on UMessageCenterListItem_C");
static_assert(sizeof(UMessageCenterListItem_C) == 0x322CBBB8, "Wrong size on UMessageCenterListItem_C");
