...
struct alignas(0x33) GCNL_GM_ReflectDamage_C_ExecuteUbergraph_GCNL_GM_ReflectDamage final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_Event_DeltaSeconds;                         // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(GCNL_GM_ReflectDamage_C_ExecuteUbergraph_GCNL_GM_ReflectDamage) == 0x000033, "Wrong alignment on GCNL_GM_ReflectDamage_C_ExecuteUbergraph_GCNL_GM_ReflectDamage");
static_assert(sizeof(GCNL_GM_ReflectDamage_C_ExecuteUbergraph_GCNL_GM_ReflectDamage) == 0x000033, "Wrong size on GCNL_GM_ReflectDamage_C_ExecuteUbergraph_GCNL_GM_ReflectDamage");
...
public:
	...
	struct FVector                                CallFunc_K2_GetComponentLocation_ReturnValue;      // 0x00C0(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x00D8(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Subtract_VectorVector_ReturnValue;        // 0x00F0(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetSocketLocation_ReturnValue;            // 0x00FC(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x0108(0x11821300)(IsPlainOldData, NoDestructor)
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue;         // 0x0114(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue2;        // 0x0128(0x11821300)(IsPlainOldData, NoDestructor)
	float                                         CallFunc_VSize_ReturnValue;                        // 0x0134(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x0138(0x11827600)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                                CallFunc_GetSocketLocation_ReturnValue2;           // 0x01C4(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Subtract_VectorVector_ReturnValue2;       // 0x01D0(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_MakeVector_ReturnValue;                   // 0x01DC(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_RandomUnitVector_ReturnValue;             // 0x01E8(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Multiply_VectorVector_ReturnValue;        // 0x01F4(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Add_VectorVector_ReturnValue;             // 0x0200(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult;    // 0x0210(0x11827600)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
static_assert(alignof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned) == 0x11821D80, "Wrong alignment on GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned");
static_assert(sizeof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned) == 0x11821D80, "Wrong size on GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned");
