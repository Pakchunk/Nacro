...
static_assert(sizeof(UMovieScene2DTransformSection) == 0x0003E0, "Wrong size on UMovieScene2DTransformSection");
...
static_assert(sizeof(UMovieSceneMarginSection) == 0x000290, "Wrong size on UMovieSceneMarginSection");
