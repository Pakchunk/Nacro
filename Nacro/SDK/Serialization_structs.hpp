...
// 0x33DB4000 (0x33DB4000 - 0x0000)
struct alignas(0x33DB4000) FStructSerializerNumericTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerNumericTestStruct) == 0x33DB4000, "Wrong alignment on FStructSerializerNumericTestStruct");
static_assert(sizeof(FStructSerializerNumericTestStruct) == 0x33DB4000, "Wrong size on FStructSerializerNumericTestStruct");
...
// 0x1182E200 (0x1182E200 - 0x0000)
struct alignas(0x1182E200) FStructSerializerBooleanTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerBooleanTestStruct) == 0x1182E200, "Wrong alignment on FStructSerializerBooleanTestStruct");
static_assert(sizeof(FStructSerializerBooleanTestStruct) == 0x1182E200, "Wrong size on FStructSerializerBooleanTestStruct");
...
struct alignas(0x33DB3E80) FStructSerializerMapTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerMapTestStruct) == 0x33DB3E80, "Wrong alignment on FStructSerializerMapTestStruct");
static_assert(sizeof(FStructSerializerMapTestStruct) == 0x33DB3E80, "Wrong size on FStructSerializerMapTestStruct");
...
// 0x33DB3E80 (0x33DB3E80 - 0x0000)
struct alignas(0x33DB3E80) FStructSerializerObjectTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerObjectTestStruct) == 0x33DB3E80, "Wrong alignment on FStructSerializerObjectTestStruct");
static_assert(sizeof(FStructSerializerObjectTestStruct) == 0x33DB3E80, "Wrong size on FStructSerializerObjectTestStruct");
...
// 0x33DB3E80 (0x33DB3E80 - 0x0000)
struct alignas(0x33DB3E80) FStructSerializerBuiltinTestStruct final
{
public:
	struct FGuid                                  Guid;                                              // 0x0000(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FRotator                               Rotator;                                           // 0x0028(0x11821300)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	class FText                                   Text;                                              // 0x0038(0x0018)(NativeAccessSpecifierPublic)
	struct FVector                                Vector;                                            // 0x0050(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FStructSerializerBuiltinTestStruct) == 0x33DB3E80, "Wrong alignment on FStructSerializerBuiltinTestStruct");
static_assert(sizeof(FStructSerializerBuiltinTestStruct) == 0x33DB3E80, "Wrong size on FStructSerializerBuiltinTestStruct");
...
// 0x33DB3E80 (0x33DB3E80 - 0x0000)
struct alignas(0x33DB3E80) FStructSerializerArrayTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerArrayTestStruct) == 0x33DB3E80, "Wrong alignment on FStructSerializerArrayTestStruct");
static_assert(sizeof(FStructSerializerArrayTestStruct) == 0x33DB3E80, "Wrong size on FStructSerializerArrayTestStruct");
...
{
public:
	struct FStructSerializerNumericTestStruct     Numerics;                                          // 0x0000(0x33DB4000)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStructSerializerBooleanTestStruct     Booleans;                                          // 0x0030(0x1182E200)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStructSerializerObjectTestStruct      Objects;                                           // 0x0038(0x33DB3E80)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStructSerializerBuiltinTestStruct     Builtins;                                          // 0x0048(0x33DB3E80)(NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct       Arrays;                                            // 0x00A8(0x33DB3E80)(NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct         Maps;                                              // 0x00E8(0x33DB3E80)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FStructSerializerTestStruct) == 0x33DB4000, "Wrong alignment on FStructSerializerTestStruct");
static_assert(sizeof(FStructSerializerTestStruct) == 0x33DB4000, "Wrong size on FStructSerializerTestStruct");
