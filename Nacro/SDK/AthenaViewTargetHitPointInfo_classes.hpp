...
static_assert(alignof(UAthenaViewTargetHitPointInfo_C) == 0x322CBBB8, "Wrong alignment on UAthenaViewTargetHitPointInfo_C");
static_assert(sizeof(UAthenaViewTargetHitPointInfo_C) == 0x322CBBB8, "Wrong size on UAthenaViewTargetHitPointInfo_C");
