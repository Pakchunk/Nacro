...
class AmWaterMeshBlueprintMaster_C final : public AActor
{
public:
...
public:
	...
	static class AmWaterMeshBlueprintMaster_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AmWaterMeshBlueprintMaster_C>();
	}
};
static_assert(alignof(AmWaterMeshBlueprintMaster_C) == 0x000008, "Wrong alignment on AmWaterMeshBlueprintMaster_C");
static_assert(sizeof(AmWaterMeshBlueprintMaster_C) == 0x000450, "Wrong size on AmWaterMeshBlueprintMaster_C");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, UberGraphFrame) == 0x000388, "Member 'AmWaterMeshBlueprintMaster_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, CollisionMesh1) == 0x000390, "Member 'AmWaterMeshBlueprintMaster_C::CollisionMesh1' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, CollisionMesh2) == 0x000398, "Member 'AmWaterMeshBlueprintMaster_C::CollisionMesh2' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, CollisionMesh4) == 0x0003A0, "Member 'AmWaterMeshBlueprintMaster_C::CollisionMesh4' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, CollisionMesh3) == 0x0003A8, "Member 'AmWaterMeshBlueprintMaster_C::CollisionMesh3' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, StaticMesh1) == 0x0003B0, "Member 'AmWaterMeshBlueprintMaster_C::StaticMesh1' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Number_of_Collision_Meshes) == 0x0003B8, "Member 'AmWaterMeshBlueprintMaster_C::Number_of_Collision_Meshes' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, EnterExitWaterSplash_Ripple_Texture_Particle) == 0x0003C0, "Member 'AmWaterMeshBlueprintMaster_C::EnterExitWaterSplash_Ripple_Texture_Particle' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, EnterExitWaterSplash_Visual_Particle) == 0x0003C8, "Member 'AmWaterMeshBlueprintMaster_C::EnterExitWaterSplash_Visual_Particle' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, FlipFlow) == 0x0003D0, "Member 'AmWaterMeshBlueprintMaster_C::FlipFlow' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, NoFlow) == 0x0003D1, "Member 'AmWaterMeshBlueprintMaster_C::NoFlow' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, FlippedMaterial) == 0x0003D8, "Member 'AmWaterMeshBlueprintMaster_C::FlippedMaterial' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Internal_volume_penetration_Counter) == 0x0003E0, "Member 'AmWaterMeshBlueprintMaster_C::Internal_volume_penetration_Counter' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, PlayerGenericArray) == 0x0003F0, "Member 'AmWaterMeshBlueprintMaster_C::PlayerGenericArray' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, WaterRingArray) == 0x000400, "Member 'AmWaterMeshBlueprintMaster_C::WaterRingArray' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Current_Characters_Personal_Water_Counter) == 0x000410, "Member 'AmWaterMeshBlueprintMaster_C::Current_Characters_Personal_Water_Counter' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, ArrayOfCollisionComponentsPerActor) == 0x000418, "Member 'AmWaterMeshBlueprintMaster_C::ArrayOfCollisionComponentsPerActor' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Water_Interactions) == 0x000428, "Member 'AmWaterMeshBlueprintMaster_C::Water_Interactions' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Entering_True_Exiting_False) == 0x000429, "Member 'AmWaterMeshBlueprintMaster_C::Entering_True_Exiting_False' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, ExternalActor) == 0x000430, "Member 'AmWaterMeshBlueprintMaster_C::ExternalActor' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Internal_Mesh) == 0x000438, "Member 'AmWaterMeshBlueprintMaster_C::Internal_Mesh' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Continue) == 0x000440, "Member 'AmWaterMeshBlueprintMaster_C::Continue' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Minimum_time_between_splashes) == 0x000444, "Member 'AmWaterMeshBlueprintMaster_C::Minimum_time_between_splashes' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, ShowTestMesh) == 0x000448, "Member 'AmWaterMeshBlueprintMaster_C::ShowTestMesh' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, HasExecutedConstuctionScript) == 0x000449, "Member 'AmWaterMeshBlueprintMaster_C::HasExecutedConstuctionScript' has a wrong offset!");
static_assert(offsetof(AmWaterMeshBlueprintMaster_C, Is_Deep_Water_Asset_) == 0x00044A, "Member 'AmWaterMeshBlueprintMaster_C::Is_Deep_Water_Asset_' has a wrong offset!");
