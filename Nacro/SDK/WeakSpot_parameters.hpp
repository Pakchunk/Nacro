...
public:
	...
	struct FLinearColor                           CallFunc_GetVectorParameterValue_ReturnValue;      // 0x0038(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_MakeVector_ReturnValue;                   // 0x0048(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_MakeVector_ReturnValue2;                  // 0x006C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Subtract_VectorVector_ReturnValue;        // 0x0078(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_IntInt_ReturnValue;            // 0x0084(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_85[0x3];                                       // 0x0085(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x0088(0x11821300)(IsPlainOldData, NoDestructor)
	struct FTransform                             CallFunc_MakeTransform_ReturnValue;                // 0x00A0(0x11821300)(IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x00F8(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue2;         // 0x0120(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Conv_FloatToVector_ReturnValue;           // 0x0158(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WeakSpot_C_ExecuteUbergraph_WeakSpot) == 0x11821D80, "Wrong alignment on WeakSpot_C_ExecuteUbergraph_WeakSpot");
static_assert(sizeof(WeakSpot_C_ExecuteUbergraph_WeakSpot) == 0x11821D80, "Wrong size on WeakSpot_C_ExecuteUbergraph_WeakSpot");
...
public:
	...
	struct FVector                                CallFunc_K2_GetComponentLocation_ReturnValue;      // 0x0020(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Conv_FloatToVector_ReturnValue;           // 0x002C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x0038(0x11827600)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
static_assert(alignof(WeakSpot_C_UserConstructionScript) == 0x11821D80, "Wrong alignment on WeakSpot_C_UserConstructionScript");
static_assert(sizeof(WeakSpot_C_UserConstructionScript) == 0x11821D80, "Wrong size on WeakSpot_C_UserConstructionScript");
