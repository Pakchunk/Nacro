...
static_assert(alignof(UV3_PlayerCameraModeMelee_C) == 0x11821D80, "Wrong alignment on UV3_PlayerCameraModeMelee_C");
static_assert(sizeof(UV3_PlayerCameraModeMelee_C) == 0x11821D80, "Wrong size on UV3_PlayerCameraModeMelee_C");
