...
public:
	...
	unsigned char                                      bTemplateInitialized : 1;                                 // 0x0338(0x0001) (Transient)
	unsigned char                                      bCookedTemplate : 1;                                      // 0x0338(0x0001) (Transient)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0339(0x0007) MISSED OFFSET
	TArray<struct FDelegateRuntimeBinding>             Bindings;                                                 // 0x0340(0x0010) (ZeroConstructor)
	TArray<class UWidgetAnimation*>                    Animations;                                               // 0x0350(0x0010) (ExportObject, ZeroConstructor)
	TArray<struct FName>                               NamedSlots;                                               // 0x0360(0x0010) (ZeroConstructor)
	TAssetPtr<class UUserWidget>                       TemplateAsset;                                            // 0x0370(0x0020) (ExportObject, InstancedReference)
	class UUserWidget*                                 Template;                                                 // 0x0390(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0D28(0x0010) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x09D0(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FLinearColor                                ColorAndOpacity;                                          // 0x01B0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
...
public:
	...
	EDescendantScrollDestination                       NavigationDestination;                                    // 0x08AD(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FLinearColor                                FillColorAndOpacity;                                      // 0x0308(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0220(0x0010) (ZeroConstructor, InstancedReference)
...
{
public:
	class UClass*                                      WidgetClass;                                              // 0x0780(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0788(0x0008) (Edit, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0790(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0791(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0792(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x0794(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0798(0x0008) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x07A0(0x0008) (IsPlainOldData)
	bool                                               bDrawAtDesiredSize;                                       // 0x07A8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x07A9(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x07AC(0x0008) (Edit, IsPlainOldData)
	bool                                               bReceiveHardwareInput;                                    // 0x07B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x07B5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x07B6(0x0002) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x07B8(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x07C0(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x07D0(0x0010) (Edit, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x07E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x07E4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x07E5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x07E6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1];                                       // 0x07E7(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x07E8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData05[0x20];                                      // 0x07F0(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x0810(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x0818(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x0820(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x0828(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x0830(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x0838(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x0840(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x0848(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
