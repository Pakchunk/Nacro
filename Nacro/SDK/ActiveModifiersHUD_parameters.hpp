...
struct alignas(0x1F) ActiveModifiersHUD_C_ExecuteUbergraph_ActiveModifiersHUD final
{
public:
...
static_assert(alignof(ActiveModifiersHUD_C_ExecuteUbergraph_ActiveModifiersHUD) == 0x00001F, "Wrong alignment on ActiveModifiersHUD_C_ExecuteUbergraph_ActiveModifiersHUD");
static_assert(sizeof(ActiveModifiersHUD_C_ExecuteUbergraph_ActiveModifiersHUD) == 0x00005D, "Wrong size on ActiveModifiersHUD_C_ExecuteUbergraph_ActiveModifiersHUD");
...
public:
	...
	struct FMargin                                K2Node_MakeStruct_Margin;                          // 0x0034(0x322CBBB8)(NoDestructor)
	...
	struct FSlateBrush                            CallFunc_GetSmallPreviewImageBrush_ReturnValue;    // 0x0068(0x322CBBB8)()
...
static_assert(alignof(ActiveModifiersHUD_C_PopulateModifiers) == 0x322CBBB8, "Wrong alignment on ActiveModifiersHUD_C_PopulateModifiers");
static_assert(sizeof(ActiveModifiersHUD_C_PopulateModifiers) == 0x322CBBB8, "Wrong size on ActiveModifiersHUD_C_PopulateModifiers");
