...
static_assert(alignof(UGE_DefaultPlayer_HarvestBuffHit_C) == 0x1182E980, "Wrong alignment on UGE_DefaultPlayer_HarvestBuffHit_C");
static_assert(sizeof(UGE_DefaultPlayer_HarvestBuffHit_C) == 0x1182E980, "Wrong size on UGE_DefaultPlayer_HarvestBuffHit_C");
