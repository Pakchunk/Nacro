...
// 0x1182B500 (0x1182B500 - 0x0000)
struct alignas(0x1182B500) FLevelSequenceObject final
{
public:
...
static_assert(alignof(FLevelSequenceObject) == 0x1182B500, "Wrong alignment on FLevelSequenceObject");
static_assert(sizeof(FLevelSequenceObject) == 0x1182B500, "Wrong size on FLevelSequenceObject");
...
// 0x1182B500 (0x1182B500 - 0x0000)
struct alignas(0x1182B500) FLevelSequenceObjectReferenceMap final
{
public:
	uint8                                         Pad_0[0x50];                                       // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequenceObjectReferenceMap) == 0x1182B500, "Wrong alignment on FLevelSequenceObjectReferenceMap");
static_assert(sizeof(FLevelSequenceObjectReferenceMap) == 0x1182B500, "Wrong size on FLevelSequenceObjectReferenceMap");

// ScriptStruct LevelSequence.LevelSequenceObjectReference
// 0x1182B500 (0x1182B500 - 0x0000)
struct alignas(0x1182B500) FLevelSequenceObjectReference final
{
public:
	uint8                                         Pad_0[0x20];                                       // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequenceObjectReference) == 0x1182B500, "Wrong alignment on FLevelSequenceObjectReference");
static_assert(sizeof(FLevelSequenceObjectReference) == 0x1182B500, "Wrong size on FLevelSequenceObjectReference");

// ScriptStruct LevelSequence.LevelSequenceSnapshotSettings
// 0x1182B800 (0x1182B800 - 0x0000)
struct alignas(0x1182B800) FLevelSequenceSnapshotSettings final
{
public:
...
static_assert(alignof(FLevelSequenceSnapshotSettings) == 0x1182B800, "Wrong alignment on FLevelSequenceSnapshotSettings");
static_assert(sizeof(FLevelSequenceSnapshotSettings) == 0x1182B800, "Wrong size on FLevelSequenceSnapshotSettings");
...
public:
	...
	struct FLevelSequenceSnapshotSettings         Settings;                                          // 0x0048(0x1182B800)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLevelSequencePlayerSnapshot) == 0x1182B800, "Wrong alignment on FLevelSequencePlayerSnapshot");
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x1182B800, "Wrong size on FLevelSequencePlayerSnapshot");
...
// 0x1182B800 (0x1182B800 - 0x0000)
struct alignas(0x1182B800) FBoundActorProxy final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBoundActorProxy) == 0x1182B800, "Wrong alignment on FBoundActorProxy");
static_assert(sizeof(FBoundActorProxy) == 0x1182B800, "Wrong size on FBoundActorProxy");
