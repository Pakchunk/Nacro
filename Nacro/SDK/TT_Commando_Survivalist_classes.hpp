...
static_assert(alignof(UTT_Commando_Survivalist_C) == 0x11821780, "Wrong alignment on UTT_Commando_Survivalist_C");
static_assert(sizeof(UTT_Commando_Survivalist_C) == 0x11821780, "Wrong size on UTT_Commando_Survivalist_C");
