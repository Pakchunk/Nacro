...
// 0x0889 (0x0889 - 0x0000)
struct alignas(0x889) PlayerChoiceWidget_C_SurvivorStoryChoiceSelected__DelegateSignature final
{
public:
	int32                                         SelectedChoice_0;                                  // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PlayerChoiceWidget_C_SurvivorStoryChoiceSelected__DelegateSignature) == 0x000889, "Wrong alignment on PlayerChoiceWidget_C_SurvivorStoryChoiceSelected__DelegateSignature");
static_assert(sizeof(PlayerChoiceWidget_C_SurvivorStoryChoiceSelected__DelegateSignature) == 0x000889, "Wrong size on PlayerChoiceWidget_C_SurvivorStoryChoiceSelected__DelegateSignature");
...
public:
	...
	struct FChoiceData                            K2Node_Event_ChoiceItems;                          // 0x0018(0x11821780)(ConstParm)
	...
	struct FChoiceDataEntry                       CallFunc_Array_Get_Item;                           // 0x0050(0x11821780)()
...
static_assert(alignof(PlayerChoiceWidget_C_ExecuteUbergraph_PlayerChoiceWidget) == 0x11821780, "Wrong alignment on PlayerChoiceWidget_C_ExecuteUbergraph_PlayerChoiceWidget");
static_assert(sizeof(PlayerChoiceWidget_C_ExecuteUbergraph_PlayerChoiceWidget) == 0x11821780, "Wrong size on PlayerChoiceWidget_C_ExecuteUbergraph_PlayerChoiceWidget");
...
{
public:
	struct FChoiceData                            ChoiceItems;                                       // 0x0000(0x11821780)(ConstParm, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(PlayerChoiceWidget_C_SetChoices) == 0x11821780, "Wrong alignment on PlayerChoiceWidget_C_SetChoices");
static_assert(sizeof(PlayerChoiceWidget_C_SetChoices) == 0x11821780, "Wrong size on PlayerChoiceWidget_C_SetChoices");
...
{
public:
	struct FChoiceDataEntry                       ChoiceData;                                        // 0x0000(0x11821780)(Parm)
...
static_assert(alignof(PlayerChoiceWidget_C_CreateButtonAndSetText) == 0x11821780, "Wrong alignment on PlayerChoiceWidget_C_CreateButtonAndSetText");
static_assert(sizeof(PlayerChoiceWidget_C_CreateButtonAndSetText) == 0x11821780, "Wrong size on PlayerChoiceWidget_C_CreateButtonAndSetText");
