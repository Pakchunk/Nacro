...
// 0x05B4 (0x05B4 - 0x0000)
struct alignas(0x5B4) GCN_RiftStaminaDrain_C_UserConstructionScript final
{
public:
...
static_assert(alignof(GCN_RiftStaminaDrain_C_UserConstructionScript) == 0x0005B4, "Wrong alignment on GCN_RiftStaminaDrain_C_UserConstructionScript");
static_assert(sizeof(GCN_RiftStaminaDrain_C_UserConstructionScript) == 0x0005B4, "Wrong size on GCN_RiftStaminaDrain_C_UserConstructionScript");
...
public:
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x00DC(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_K2_GetComponentLocation_ReturnValue;      // 0x00E8(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_Conv_VectorToLinearColor_ReturnValue;     // 0x00F4(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Add_VectorVector_ReturnValue;             // 0x0104(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_Conv_VectorToLinearColor_ReturnValue2;    // 0x0110(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemActivate) == 0x11821C00, "Wrong alignment on GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemActivate");
static_assert(sizeof(GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemActivate) == 0x11821C00, "Wrong size on GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemActivate");
...
static_assert(alignof(GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemDeactivate) == 0x11821C00, "Wrong alignment on GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemDeactivate");
static_assert(sizeof(GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemDeactivate) == 0x11821C00, "Wrong size on GCN_RiftStaminaDrain_C_OnWhileActiveParticleSystemDeactivate");
