...
// 0x11821D08 (0x11821D80 - 0x0078)
class UBluGloRequestHandler_C final : public UEnvQueryInstanceBlueprintWrapper
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0078(0x11821D80)(Transient, DuplicateTransient)
	...
	struct FVector                                LocationToSpawnFrom;                               // 0x00A0(0x11821300)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(UBluGloRequestHandler_C) == 0x11821D80, "Wrong alignment on UBluGloRequestHandler_C");
static_assert(sizeof(UBluGloRequestHandler_C) == 0x11821D80, "Wrong size on UBluGloRequestHandler_C");
