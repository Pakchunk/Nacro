...
static_assert(alignof(APBWA_M1_StairR_C) == 0x000010, "Wrong alignment on APBWA_M1_StairR_C");
static_assert(sizeof(APBWA_M1_StairR_C) == 0x000FD0, "Wrong size on APBWA_M1_StairR_C");
