...
public:
	...
	class UMovieSceneSequence*                         Sequence;                                                 // 0x03B8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              TimeCursorPosition;                                       // 0x03C0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              StartTime;                                                // 0x03C4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              EndTime;                                                  // 0x03C8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CurrentNumLoops;                                          // 0x03CC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
