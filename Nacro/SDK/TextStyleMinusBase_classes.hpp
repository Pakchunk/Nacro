...
static_assert(alignof(UTextStyleMinusBase_C) == 0x322CBBB8, "Wrong alignment on UTextStyleMinusBase_C");
static_assert(sizeof(UTextStyleMinusBase_C) == 0x322CBBB8, "Wrong size on UTextStyleMinusBase_C");
