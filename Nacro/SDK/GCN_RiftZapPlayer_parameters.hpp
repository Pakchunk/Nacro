...
public:
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x0118(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(GCN_RiftZapPlayer_C_OnExecute) == 0x11821C00, "Wrong alignment on GCN_RiftZapPlayer_C_OnExecute");
static_assert(sizeof(GCN_RiftZapPlayer_C_OnExecute) == 0x11821C00, "Wrong size on GCN_RiftZapPlayer_C_OnExecute");
