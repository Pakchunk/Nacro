...
static_assert(alignof(UResults_BonusXpType_C) == 0x322CBBB8, "Wrong alignment on UResults_BonusXpType_C");
static_assert(sizeof(UResults_BonusXpType_C) == 0x322CBBB8, "Wrong size on UResults_BonusXpType_C");
