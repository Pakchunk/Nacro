...
void UAccountLinkingWindow_C::OnAccountLinkingFailed__DelegateSignature(const class FText& FailReason)
{
	static class UFunction* Func = nullptr;
...
void UAccountLinkingWindow_C::OnPushStatus__DelegateSignature(const class FText& StatusText)
{
	static class UFunction* Func = nullptr;
