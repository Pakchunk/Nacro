...
static_assert(alignof(UOptionsMenuSlider_Light_C) == 0x322CBBB8, "Wrong alignment on UOptionsMenuSlider_Light_C");
static_assert(sizeof(UOptionsMenuSlider_Light_C) == 0x322CBBB8, "Wrong size on UOptionsMenuSlider_Light_C");
