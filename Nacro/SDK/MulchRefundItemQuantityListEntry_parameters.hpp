...
struct alignas(0xA80) MulchRefundItemQuantityListEntry_C_HandleDifferentItemOrQuantitySetBP final
{
public:
	bool                                          IsBeingReset;                                      // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(MulchRefundItemQuantityListEntry_C_HandleDifferentItemOrQuantitySetBP) == 0x000A80, "Wrong alignment on MulchRefundItemQuantityListEntry_C_HandleDifferentItemOrQuantitySetBP");
static_assert(sizeof(MulchRefundItemQuantityListEntry_C_HandleDifferentItemOrQuantitySetBP) == 0x000A80, "Wrong size on MulchRefundItemQuantityListEntry_C_HandleDifferentItemOrQuantitySetBP");
...
struct alignas(0xE4) MulchRefundItemQuantityListEntry_C_UpdateItemAndQuantity final
{
public:
...
static_assert(alignof(MulchRefundItemQuantityListEntry_C_UpdateItemAndQuantity) == 0x0000E4, "Wrong alignment on MulchRefundItemQuantityListEntry_C_UpdateItemAndQuantity");
static_assert(sizeof(MulchRefundItemQuantityListEntry_C_UpdateItemAndQuantity) == 0x0000E4, "Wrong size on MulchRefundItemQuantityListEntry_C_UpdateItemAndQuantity");
