...
static_assert(alignof(AFactory_Trim_10a_C) == 0x1182A000, "Wrong alignment on AFactory_Trim_10a_C");
static_assert(sizeof(AFactory_Trim_10a_C) == 0x1182A000, "Wrong size on AFactory_Trim_10a_C");
