...
static_assert(alignof(UGET_PeriodicEnergyDamage_C) == 0x1182E980, "Wrong alignment on UGET_PeriodicEnergyDamage_C");
static_assert(sizeof(UGET_PeriodicEnergyDamage_C) == 0x1182E980, "Wrong size on UGET_PeriodicEnergyDamage_C");
