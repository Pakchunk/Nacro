...
public:
	...
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0020(0x11827900)(IsPlainOldData, NoDestructor)
	...
	struct FWidgetTransform                       K2Node_MakeStruct_WidgetTransform;                 // 0x005C(0x11827900)(NoDestructor)
	struct FWidgetTransform                       K2Node_MakeStruct_WidgetTransform2;                // 0x0078(0x11827900)(NoDestructor)
...
static_assert(alignof(AthenaRotator_C_ExecuteUbergraph_AthenaRotator) == 0x11827900, "Wrong alignment on AthenaRotator_C_ExecuteUbergraph_AthenaRotator");
static_assert(sizeof(AthenaRotator_C_ExecuteUbergraph_AthenaRotator) == 0x11827900, "Wrong size on AthenaRotator_C_ExecuteUbergraph_AthenaRotator");
...
static_assert(alignof(AthenaRotator_C_Tick) == 0x11827900, "Wrong alignment on AthenaRotator_C_Tick");
static_assert(sizeof(AthenaRotator_C_Tick) == 0x11827900, "Wrong size on AthenaRotator_C_Tick");
