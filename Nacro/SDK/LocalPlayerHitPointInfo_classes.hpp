...
static_assert(alignof(ULocalPlayerHitPointInfo_C) == 0x322CBBB8, "Wrong alignment on ULocalPlayerHitPointInfo_C");
static_assert(sizeof(ULocalPlayerHitPointInfo_C) == 0x322CBBB8, "Wrong size on ULocalPlayerHitPointInfo_C");
