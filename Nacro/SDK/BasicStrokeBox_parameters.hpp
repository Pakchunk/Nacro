...
struct alignas(0x81) BasicStrokeBox_C_ExecuteUbergraph_BasicStrokeBox final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(BasicStrokeBox_C_ExecuteUbergraph_BasicStrokeBox) == 0x000081, "Wrong alignment on BasicStrokeBox_C_ExecuteUbergraph_BasicStrokeBox");
static_assert(sizeof(BasicStrokeBox_C_ExecuteUbergraph_BasicStrokeBox) == 0x000081, "Wrong size on BasicStrokeBox_C_ExecuteUbergraph_BasicStrokeBox");
...
public:
	...
	struct FLinearColor                           Fill_Color;                                        // 0x0004(0x11821300)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Stroke_Color;                                      // 0x0014(0x11821300)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BasicStrokeBox_C_Customize) == 0x11821300, "Wrong alignment on BasicStrokeBox_C_Customize");
static_assert(sizeof(BasicStrokeBox_C_Customize) == 0x11821300, "Wrong size on BasicStrokeBox_C_Customize");
