...
// 0x11825C80 (0x11825C80 - 0x0000)
struct alignas(0x11825C80) FQosPingServerInfo final
{
public:
...
static_assert(alignof(FQosPingServerInfo) == 0x11825C80, "Wrong alignment on FQosPingServerInfo");
static_assert(sizeof(FQosPingServerInfo) == 0x11825C80, "Wrong size on FQosPingServerInfo");
...
struct alignas(0x11AC0100) FQosDatacenterInfo final
{
public:
...
static_assert(alignof(FQosDatacenterInfo) == 0x11AC0100, "Wrong alignment on FQosDatacenterInfo");
static_assert(sizeof(FQosDatacenterInfo) == 0x11AC0100, "Wrong size on FQosDatacenterInfo");
...
{
public:
	struct FQosDatacenterInfo                     Region;                                            // 0x0000(0x11AC0100)(Transient, NativeAccessSpecifierPublic)
	...
	struct FDateTime                              LastCheckTimestamp;                                // 0x0070(0x11821300)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FQosRegionInfo) == 0x11AC0100, "Wrong alignment on FQosRegionInfo");
static_assert(sizeof(FQosRegionInfo) == 0x11AC0100, "Wrong size on FQosRegionInfo");
...
// 0x11825C80 (0x11825C80 - 0x0000)
struct alignas(0x11825C80) FQosSearchPass final
{
public:
...
static_assert(alignof(FQosSearchPass) == 0x11825C80, "Wrong alignment on FQosSearchPass");
static_assert(sizeof(FQosSearchPass) == 0x11825C80, "Wrong size on FQosSearchPass");
