...
// 0x064F (0x064F - 0x0000)
struct alignas(0x64F) ProgressWidget_C_SetTitle final
{
public:
	class FText                                   Title_0;                                           // 0x0000(0x0018)(Parm)
};
static_assert(alignof(ProgressWidget_C_SetTitle) == 0x00064F, "Wrong alignment on ProgressWidget_C_SetTitle");
static_assert(sizeof(ProgressWidget_C_SetTitle) == 0x00064F, "Wrong size on ProgressWidget_C_SetTitle");
...
struct alignas(0xE4) ProgressWidget_C_SetDescription final
{
public:
	class FText                                   Description_0;                                     // 0x0000(0x0018)(Parm)
};
static_assert(alignof(ProgressWidget_C_SetDescription) == 0x0000E4, "Wrong alignment on ProgressWidget_C_SetDescription");
static_assert(sizeof(ProgressWidget_C_SetDescription) == 0x0000E4, "Wrong size on ProgressWidget_C_SetDescription");
...
{
public:
	struct FSlateBrush                            IconBrush;                                         // 0x0000(0x322CBBB8)(Parm)
...
static_assert(alignof(ProgressWidget_C_SetIcon) == 0x11827900, "Wrong alignment on ProgressWidget_C_SetIcon");
static_assert(sizeof(ProgressWidget_C_SetIcon) == 0x11827900, "Wrong size on ProgressWidget_C_SetIcon");
