...
static_assert(alignof(QuestProgressWidget_C_Update) == 0x11821D80, "Wrong alignment on QuestProgressWidget_C_Update");
static_assert(sizeof(QuestProgressWidget_C_Update) == 0x11821D80, "Wrong size on QuestProgressWidget_C_Update");
