...
static_assert(alignof(UItemManagementInventoryLimitStatusIndicator_C) == 0x322CBBB8, "Wrong alignment on UItemManagementInventoryLimitStatusIndicator_C");
static_assert(sizeof(UItemManagementInventoryLimitStatusIndicator_C) == 0x322CBBB8, "Wrong size on UItemManagementInventoryLimitStatusIndicator_C");
