...
public:
	...
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue; // 0x00C8(0x11821C00)(NoDestructor, HasGetValueTypeHash)
	...
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue2; // 0x00E0(0x11821C00)(NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_K2_GetActorRotation_ReturnValue;          // 0x0108(0x11821300)(IsPlainOldData, NoDestructor)
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue3; // 0x0114(0x11821C00)(NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Conv_RotatorToVector_ReturnValue;         // 0x011C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue;         // 0x0128(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x0134(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Add_VectorVector_ReturnValue;             // 0x0140(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue4; // 0x014C(0x11821C00)(NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned) == 0x11822200, "Wrong alignment on GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned");
static_assert(sizeof(GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned) == 0x11822200, "Wrong size on GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned");
...
static_assert(alignof(GAB_GenericStunned_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GAB_GenericStunned_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GAB_GenericStunned_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GAB_GenericStunned_C_K2_ActivateAbilityFromEvent");
