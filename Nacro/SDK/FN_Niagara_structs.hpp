...
struct FNiagaraEmitterHandle
{
	...
	class UNiagaraEmitterProperties*                   Source;                                                   // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNiagaraEmitterProperties*                   Instance;                                                 // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FNiagaraFunctionSignature
{
	...
	struct FName                                       Owner;                                                    // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FNiagaraScriptDataInterfaceInfo
{
	...
	TArray<struct FNiagaraFunctionSignature>           ExternalFunctions;                                        // 0x0008(0x0010) (ZeroConstructor)
};
