...
public:
	...
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x0038(0x11822200)(ConstParm)
...
static_assert(alignof(GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO) == 0x11822200, "Wrong alignment on GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO");
static_assert(sizeof(GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO) == 0x11822200, "Wrong size on GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO");
...
static_assert(alignof(GAB_PlayerDBNO_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GAB_PlayerDBNO_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GAB_PlayerDBNO_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GAB_PlayerDBNO_C_K2_ActivateAbilityFromEvent");
...
static_assert(alignof(GAB_PlayerDBNO_C_InitializeDeathHitDirection) == 0x11822200, "Wrong alignment on GAB_PlayerDBNO_C_InitializeDeathHitDirection");
static_assert(sizeof(GAB_PlayerDBNO_C_InitializeDeathHitDirection) == 0x11822200, "Wrong size on GAB_PlayerDBNO_C_InitializeDeathHitDirection");
