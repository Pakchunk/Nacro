...
public:
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x005C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue2;         // 0x007C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Variable;                                 // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_GetCameraRotation_ReturnValue;            // 0x008C(0x11821300)(IsPlainOldData, NoDestructor)
...
static_assert(alignof(AthenaCompass_C_ExecuteUbergraph_AthenaCompass) == 0x11827900, "Wrong alignment on AthenaCompass_C_ExecuteUbergraph_AthenaCompass");
static_assert(sizeof(AthenaCompass_C_ExecuteUbergraph_AthenaCompass) == 0x11827900, "Wrong size on AthenaCompass_C_ExecuteUbergraph_AthenaCompass");
...
static_assert(alignof(AthenaCompass_C_Tick) == 0x11827900, "Wrong alignment on AthenaCompass_C_Tick");
static_assert(sizeof(AthenaCompass_C_Tick) == 0x11827900, "Wrong size on AthenaCompass_C_Tick");
...
{
public:
	struct FRotator                               InRot;                                             // 0x0000(0x11821300)(Parm, IsPlainOldData, NoDestructor)
...
static_assert(alignof(AthenaCompass_C_UpdateCompassMaterial) == 0x11821300, "Wrong alignment on AthenaCompass_C_UpdateCompassMaterial");
static_assert(sizeof(AthenaCompass_C_UpdateCompassMaterial) == 0x11821300, "Wrong size on AthenaCompass_C_UpdateCompassMaterial");
...
public:
	...
	struct FVector2D                              MarkerWorldPosition;                               // 0x0008(0x11821300)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CameraRotation;                                    // 0x0010(0x11821300)(Parm, IsPlainOldData, NoDestructor)
	struct FVector                                PawnLocation;                                      // 0x001C(0x11821300)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Conv_Vector2DToVector_ReturnValue;        // 0x0038(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x0050(0x11821300)(IsPlainOldData, NoDestructor)
	...
	struct FRotator                               CallFunc_NormalizedDeltaRotator_ReturnValue;       // 0x0064(0x11821300)(IsPlainOldData, NoDestructor)
...
static_assert(alignof(AthenaCompass_C_UpdateMarker) == 0x11821300, "Wrong alignment on AthenaCompass_C_UpdateMarker");
static_assert(sizeof(AthenaCompass_C_UpdateMarker) == 0x11821300, "Wrong size on AthenaCompass_C_UpdateMarker");
