...
static_assert(alignof(GA_DefaultPlayer_BuildingCreated_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingCreated) == 0x11822200, "Wrong alignment on GA_DefaultPlayer_BuildingCreated_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingCreated");
static_assert(sizeof(GA_DefaultPlayer_BuildingCreated_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingCreated) == 0x11822200, "Wrong size on GA_DefaultPlayer_BuildingCreated_C_ExecuteUbergraph_GA_DefaultPlayer_BuildingCreated");
...
static_assert(alignof(GA_DefaultPlayer_BuildingCreated_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GA_DefaultPlayer_BuildingCreated_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GA_DefaultPlayer_BuildingCreated_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GA_DefaultPlayer_BuildingCreated_C_K2_ActivateAbilityFromEvent");
