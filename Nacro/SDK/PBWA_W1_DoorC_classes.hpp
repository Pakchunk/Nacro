...
static_assert(alignof(APBWA_W1_DoorC_C) == 0x000010, "Wrong alignment on APBWA_W1_DoorC_C");
static_assert(sizeof(APBWA_W1_DoorC_C) == 0x0010B0, "Wrong size on APBWA_W1_DoorC_C");
