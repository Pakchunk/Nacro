...
public:
	...
	class UVerticalBox*                           mVertical_Box__Durability;                         // 0x0238(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UTooltipDurabilityMeter_C, mVertical_Box__Durability) == 0x000238, "Member 'UTooltipDurabilityMeter_C::mVertical_Box__Durability' has a wrong offset!");
