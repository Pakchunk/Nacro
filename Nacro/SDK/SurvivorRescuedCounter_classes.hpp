...
static_assert(alignof(USurvivorRescuedCounter_C) == 0x322CBBB8, "Wrong alignment on USurvivorRescuedCounter_C");
static_assert(sizeof(USurvivorRescuedCounter_C) == 0x322CBBB8, "Wrong size on USurvivorRescuedCounter_C");
