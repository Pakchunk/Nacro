...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_PlayerPawn_Commando_C;              // 0x1C28(0x11821D80)(Transient, DuplicateTransient)
	...
	struct FGameplayTagContainer                  TC_FlakVest;                                       // 0x1C70(0x11821C00)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayEventData                     Event_Data;                                        // 0x1C90(0x11822200)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTag                           EventSpawnEffect;                                  // 0x1D38(0x11821D80)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(APlayerPawn_Commando_C) == 0x1182EB00, "Wrong alignment on APlayerPawn_Commando_C");
static_assert(sizeof(APlayerPawn_Commando_C) == 0x1182EB00, "Wrong size on APlayerPawn_Commando_C");
