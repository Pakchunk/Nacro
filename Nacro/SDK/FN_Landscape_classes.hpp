...
public:
	...
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                        // 0x0698(0x0010) (ZeroConstructor)
	TArray<struct FWeightmapLayerAllocationInfo>       WeightmapLayerAllocations;                                // 0x06A8(0x0010) (ZeroConstructor)
	TArray<class UTexture2D*>                          WeightmapTextures;                                        // 0x06B8(0x0010) (ZeroConstructor)
	class UTexture2D*                                  XYOffsetmapTexture;                                       // 0x06C8(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector4                                    WeightmapScaleBias;                                       // 0x06D0(0x0010) (IsPlainOldData)
	...
	struct FVector4                                    HeightmapScaleBias;                                       // 0x06F0(0x0010) (IsPlainOldData)
	class UTexture2D*                                  HeightmapTexture;                                         // 0x0700(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FBox                                        CachedLocalBox;                                           // 0x0708(0x001C) (IsPlainOldData)
	...
	struct FGuid                                       MapBuildDataId;                                           // 0x0740(0x0010) (IsPlainOldData)
	TArray<struct FGuid>                               IrrelevantLights;                                         // 0x0750(0x0010) (ZeroConstructor, Deprecated)
	...
	struct FGuid                                       StateId;                                                  // 0x077C(0x0010) (IsPlainOldData)
	struct FGuid                                       BakedTextureMaterialGuid;                                 // 0x078C(0x0010) (IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x079C(0x0004) MISSED OFFSET
	class UTexture2D*                                  GIBakedBaseColorTexture;                                  // 0x07A0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      MobileBlendableLayerMask;                                 // 0x07A8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x07A9(0x0007) MISSED OFFSET
	class UMaterialInterface*                          MobileMaterialInterface;                                  // 0x07B0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  MobileWeightNormalmapTexture;                             // 0x07B8(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FGuid                                       HeightfieldGuid;                                          // 0x06A8(0x0010) (IsPlainOldData)
	struct FBox                                        CachedLocalBox;                                           // 0x06B8(0x001C) (IsPlainOldData)
	TLazyObjectPtr<class ULandscapeComponent>          RenderComponent;                                          // 0x06D4(0x001C) (ExportObject, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x06F0(0x0010) MISSED OFFSET
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                  // 0x0700(0x0010) (ZeroConstructor)
...
{
public:
	struct FGuid                                       MeshGuid;                                                 // 0x0750(0x0010) (IsPlainOldData)
...
{
public:
	struct FGuid                                       LandscapeGuid;                                            // 0x07E0(0x0010) (IsPlainOldData)
...
public:
	...
	struct FLightingChannels                           LightingChannels;                                         // 0x047C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x04B0(0x0220) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bGenerateOverlapEvents : 1;                               // 0x06D0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bBakeMaterialPositionOffsetIntoCollision : 1;             // 0x06D0(0x0001) (Edit)
	unsigned char                                      UnknownData08[0x3];                                       // 0x06D1(0x0003) MISSED OFFSET
	int                                                ComponentSizeQuads;                                       // 0x06D4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x06D8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x06DC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUsedForNavigation : 1;                                   // 0x06E0(0x0001) (Edit)
	unsigned char                                      UnknownData09[0x3];                                       // 0x06E1(0x0003) MISSED OFFSET
	ENavDataGatheringMode                              NavigationGeometryGatheringMode;                          // 0x06E4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeForCullingInvisibleHLODVertices;             // 0x06E5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
