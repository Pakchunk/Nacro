...
static_assert(alignof(AWM_PinHard_C) == 0x11821D80, "Wrong alignment on AWM_PinHard_C");
static_assert(sizeof(AWM_PinHard_C) == 0x11821D80, "Wrong size on AWM_PinHard_C");
