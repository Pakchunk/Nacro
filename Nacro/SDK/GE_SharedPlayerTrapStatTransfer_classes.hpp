...
static_assert(alignof(UGE_SharedPlayerTrapStatTransfer_C) == 0x1182E980, "Wrong alignment on UGE_SharedPlayerTrapStatTransfer_C");
static_assert(sizeof(UGE_SharedPlayerTrapStatTransfer_C) == 0x1182E980, "Wrong size on UGE_SharedPlayerTrapStatTransfer_C");
