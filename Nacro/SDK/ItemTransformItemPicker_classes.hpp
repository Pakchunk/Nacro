...
static_assert(alignof(UItemTransformItemPicker_C) == 0x322CBBB8, "Wrong alignment on UItemTransformItemPicker_C");
static_assert(sizeof(UItemTransformItemPicker_C) == 0x322CBBB8, "Wrong size on UItemTransformItemPicker_C");
