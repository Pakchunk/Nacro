...
public:
	...
	static class UMissionRewardItemMinusTooltip_C* GetDefaultObj()
	{
...
static_assert(offsetof(UMissionRewardItemMinusTooltip_C, Item) == 0x000248, "Member 'UMissionRewardItemMinusTooltip_C::Item' has a wrong offset!");
static_assert(offsetof(UMissionRewardItemMinusTooltip_C, DisplayName) == 0x000250, "Member 'UMissionRewardItemMinusTooltip_C::DisplayName' has a wrong offset!");
