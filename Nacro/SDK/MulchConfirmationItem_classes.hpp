...
static_assert(alignof(UMulchConfirmationItem_C) == 0x322CBBB8, "Wrong alignment on UMulchConfirmationItem_C");
static_assert(sizeof(UMulchConfirmationItem_C) == 0x322CBBB8, "Wrong size on UMulchConfirmationItem_C");
