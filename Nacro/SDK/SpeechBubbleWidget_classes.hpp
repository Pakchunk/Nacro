...
static_assert(alignof(USpeechBubbleWidget_C) == 0x322CBBB8, "Wrong alignment on USpeechBubbleWidget_C");
static_assert(sizeof(USpeechBubbleWidget_C) == 0x322CBBB8, "Wrong size on USpeechBubbleWidget_C");
