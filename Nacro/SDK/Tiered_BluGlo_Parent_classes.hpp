...
static_assert(alignof(ATiered_BluGlo_Parent_C) == 0x1182A000, "Wrong alignment on ATiered_BluGlo_Parent_C");
static_assert(sizeof(ATiered_BluGlo_Parent_C) == 0x1182A000, "Wrong size on ATiered_BluGlo_Parent_C");
