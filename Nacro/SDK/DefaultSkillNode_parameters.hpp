...
public:
	...
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue2;                 // 0x0010(0x11821D80)(NoDestructor)
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue3;                 // 0x0018(0x11821D80)(NoDestructor)
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue4;                 // 0x0020(0x11821D80)(NoDestructor)
	struct FHomebaseNode                          CallFunc_TryGetStaticSkillTreeNodeData_OutNodeData; // 0x0028(0x1182E980)()
...
static_assert(alignof(DefaultSkillNode_C_ExecuteUbergraph_DefaultSkillNode) == 0x1182E980, "Wrong alignment on DefaultSkillNode_C_ExecuteUbergraph_DefaultSkillNode");
static_assert(sizeof(DefaultSkillNode_C_ExecuteUbergraph_DefaultSkillNode) == 0x1182E980, "Wrong size on DefaultSkillNode_C_ExecuteUbergraph_DefaultSkillNode");
...
struct alignas(0x48) DefaultSkillNode_C_PreConstruct final
{
public:
	bool                                          IsDesignTime;                                      // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(DefaultSkillNode_C_PreConstruct) == 0x000048, "Wrong alignment on DefaultSkillNode_C_PreConstruct");
static_assert(sizeof(DefaultSkillNode_C_PreConstruct) == 0x000048, "Wrong size on DefaultSkillNode_C_PreConstruct");
...
public:
	...
	struct FHomebaseNodeState                     CallFunc_TryGetSkillTreeNodeState_OutNodeState;    // 0x0008(0x11821780)(NoDestructor)
	bool                                          CallFunc_TryGetSkillTreeNodeState_ReturnValue;     // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(DefaultSkillNode_C_UpdateFromNodeState) == 0x11821780, "Wrong alignment on DefaultSkillNode_C_UpdateFromNodeState");
static_assert(sizeof(DefaultSkillNode_C_UpdateFromNodeState) == 0x11821780, "Wrong size on DefaultSkillNode_C_UpdateFromNodeState");
...
public:
	class UMaterialInstanceDynamic*               CallFunc_GetSingleMaterialStyleMID_ReturnValue;    // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortSkillTreeNodeDisplayData          CallFunc_TryGetNodeDisplayData_OutDisplayData;     // 0x0008(0x1182E980)()
	bool                                          CallFunc_TryGetNodeDisplayData_ReturnValue;        // 0x0370(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_371[0x7];                                      // 0x0371(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHomebaseNode                          CallFunc_TryGetStaticSkillTreeNodeData_OutNodeData; // 0x0378(0x1182E980)()
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue;                 // 0x0440(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(DefaultSkillNode_C_UpdateFromNodeData) == 0x1182E980, "Wrong alignment on DefaultSkillNode_C_UpdateFromNodeData");
static_assert(sizeof(DefaultSkillNode_C_UpdateFromNodeData) == 0x1182E980, "Wrong size on DefaultSkillNode_C_UpdateFromNodeData");
...
// 0x00FA (0x00FA - 0x0000)
struct alignas(0xFA) DefaultSkillNode_C_UpdateHoverGlow final
{
public:
	class UMaterialInstanceDynamic*               CallFunc_GetSingleMaterialStyleMID_ReturnValue;    // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(DefaultSkillNode_C_UpdateHoverGlow) == 0x0000FA, "Wrong alignment on DefaultSkillNode_C_UpdateHoverGlow");
static_assert(sizeof(DefaultSkillNode_C_UpdateHoverGlow) == 0x0000FA, "Wrong size on DefaultSkillNode_C_UpdateHoverGlow");
...
struct alignas(0x114) DefaultSkillNode_C_UpdateFromButtonState final
{
public:
...
static_assert(alignof(DefaultSkillNode_C_UpdateFromButtonState) == 0x000114, "Wrong alignment on DefaultSkillNode_C_UpdateFromButtonState");
static_assert(sizeof(DefaultSkillNode_C_UpdateFromButtonState) == 0x000114, "Wrong size on DefaultSkillNode_C_UpdateFromButtonState");
...
public:
	...
	struct FLinearColor                           K2Node_Select2_Default;                            // 0x0020(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           K2Node_Select3_Default;                            // 0x0030(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           K2Node_Select4_Default;                            // 0x0040(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(DefaultSkillNode_C_SetBackgroundColor) == 0x11821300, "Wrong alignment on DefaultSkillNode_C_SetBackgroundColor");
static_assert(sizeof(DefaultSkillNode_C_SetBackgroundColor) == 0x11821300, "Wrong size on DefaultSkillNode_C_SetBackgroundColor");
