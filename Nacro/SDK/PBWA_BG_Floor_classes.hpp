...
static_assert(alignof(APBWA_BG_Floor_C) == 0x1182A000, "Wrong alignment on APBWA_BG_Floor_C");
static_assert(sizeof(APBWA_BG_Floor_C) == 0x1182A000, "Wrong size on APBWA_BG_Floor_C");
