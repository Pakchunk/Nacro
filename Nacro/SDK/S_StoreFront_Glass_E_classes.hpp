...
static_assert(alignof(AS_StoreFront_Glass_E_C) == 0x1182A000, "Wrong alignment on AS_StoreFront_Glass_E_C");
static_assert(sizeof(AS_StoreFront_Glass_E_C) == 0x1182A000, "Wrong size on AS_StoreFront_Glass_E_C");
