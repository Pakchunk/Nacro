...
static_assert(alignof(UTooltipMinusDescriptionText_C) == 0x322CBBB8, "Wrong alignment on UTooltipMinusDescriptionText_C");
static_assert(sizeof(UTooltipMinusDescriptionText_C) == 0x322CBBB8, "Wrong size on UTooltipMinusDescriptionText_C");
