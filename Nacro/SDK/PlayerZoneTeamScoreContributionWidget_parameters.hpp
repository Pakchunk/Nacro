...
public:
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUniqueID_ReturnValue;                  // 0x0058(0x11821780)(HasGetValueTypeHash)
...
static_assert(alignof(PlayerZoneTeamScoreContributionWidget_C_Initialize) == 0x11821D80, "Wrong alignment on PlayerZoneTeamScoreContributionWidget_C_Initialize");
static_assert(sizeof(PlayerZoneTeamScoreContributionWidget_C_Initialize) == 0x11821D80, "Wrong size on PlayerZoneTeamScoreContributionWidget_C_Initialize");
...
static_assert(alignof(PlayerZoneTeamScoreContributionWidget_C_Update_Contribution_LERP) == 0x11821D80, "Wrong alignment on PlayerZoneTeamScoreContributionWidget_C_Update_Contribution_LERP");
static_assert(sizeof(PlayerZoneTeamScoreContributionWidget_C_Update_Contribution_LERP) == 0x11821D80, "Wrong size on PlayerZoneTeamScoreContributionWidget_C_Update_Contribution_LERP");
