...
// 0x49AB2E00 (0x49AB2E00 - 0x0000)
struct alignas(0x49AB2E00) PlayerPawn_Commando_C_ExecuteUbergraph_PlayerPawn_Commando final
{
public:
	...
	struct FGameplayEventData                     K2Node_MakeStruct_GameplayEventData;               // 0x00F8(0x11822200)()
	...
	struct FGameplayCueParameters                 K2Node_GameplayCueEvent_Parameters5;               // 0x01B0(0x11827600)(ContainsInstancedReference)
	bool                                          K2Node_SwitchEnum2_CmpSuccess;                     // 0x0268(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_269[0x3];                                      // 0x0269(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               CallFunc_MakeRotFromX_ReturnValue;                 // 0x026C(0x11821300)(IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_MakeVector_ReturnValue;                   // 0x028C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_MakeVector_ReturnValue2;                  // 0x0298(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayCueParameters                 K2Node_GameplayCueEvent_Parameters4;               // 0x02A8(0x11827600)(ContainsInstancedReference)
	...
	struct FGameplayCueParameters                 K2Node_GameplayCueEvent_Parameters3;               // 0x0368(0x11827600)(ContainsInstancedReference)
	...
	struct FGameplayCueParameters                 K2Node_GameplayCueEvent_Parameters2;               // 0x0428(0x11827600)(ContainsInstancedReference)
	...
	struct FTransform                             CallFunc_GetSocketTransform_ReturnValue;           // 0x0530(0x11821300)(IsPlainOldData, NoDestructor)
...
static_assert(alignof(PlayerPawn_Commando_C_ExecuteUbergraph_PlayerPawn_Commando) == 0x49AB2E00, "Wrong alignment on PlayerPawn_Commando_C_ExecuteUbergraph_PlayerPawn_Commando");
static_assert(sizeof(PlayerPawn_Commando_C_ExecuteUbergraph_PlayerPawn_Commando) == 0x49AB2E00, "Wrong size on PlayerPawn_Commando_C_ExecuteUbergraph_PlayerPawn_Commando");
...
static_assert(alignof(PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_MakeItRain) == 0x11821C00, "Wrong alignment on PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_MakeItRain");
static_assert(sizeof(PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_MakeItRain) == 0x11821C00, "Wrong size on PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_MakeItRain");
...
// 0x400AD32B (0x400AD32B - 0x0000)
struct alignas(0x400AD32B) PlayerPawn_Commando_C_SelectPawn final
{
public:
	class UAnimInstance*                          AnimInst;                                          // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PlayerPawn_Commando_C_SelectPawn) == 0x400AD32B, "Wrong alignment on PlayerPawn_Commando_C_SelectPawn");
static_assert(sizeof(PlayerPawn_Commando_C_SelectPawn) == 0x400AD32B, "Wrong size on PlayerPawn_Commando_C_SelectPawn");
...
static_assert(alignof(PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_IncendiaryRounds) == 0x11821C00, "Wrong alignment on PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_IncendiaryRounds");
static_assert(sizeof(PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_IncendiaryRounds) == 0x11821C00, "Wrong size on PlayerPawn_Commando_C_GameplayCue_Abilities_Applied_Commando_IncendiaryRounds");
...
static_assert(alignof(PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1) == 0x11821C00, "Wrong alignment on PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1");
static_assert(sizeof(PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1) == 0x11821C00, "Wrong size on PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1");
...
static_assert(alignof(PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2) == 0x11821C00, "Wrong alignment on PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2");
static_assert(sizeof(PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2) == 0x11821C00, "Wrong size on PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2");
...
static_assert(alignof(PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Commando_Shockwave) == 0x11821C00, "Wrong alignment on PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Commando_Shockwave");
static_assert(sizeof(PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Commando_Shockwave) == 0x11821C00, "Wrong size on PlayerPawn_Commando_C_GameplayCue_Abilities_Activation_Commando_Shockwave");
