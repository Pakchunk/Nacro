...
struct alignas(0x750) GA_DefaultPlayer_Death_C_ExecuteUbergraph_GA_DefaultPlayer_Death final
{
public:
...
static_assert(alignof(GA_DefaultPlayer_Death_C_ExecuteUbergraph_GA_DefaultPlayer_Death) == 0x000750, "Wrong alignment on GA_DefaultPlayer_Death_C_ExecuteUbergraph_GA_DefaultPlayer_Death");
static_assert(sizeof(GA_DefaultPlayer_Death_C_ExecuteUbergraph_GA_DefaultPlayer_Death) == 0x000750, "Wrong size on GA_DefaultPlayer_Death_C_ExecuteUbergraph_GA_DefaultPlayer_Death");
