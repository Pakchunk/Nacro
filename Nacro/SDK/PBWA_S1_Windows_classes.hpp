...
static_assert(alignof(APBWA_S1_Windows_C) == 0x000010, "Wrong alignment on APBWA_S1_Windows_C");
static_assert(sizeof(APBWA_S1_Windows_C) == 0x0010B0, "Wrong size on APBWA_S1_Windows_C");
