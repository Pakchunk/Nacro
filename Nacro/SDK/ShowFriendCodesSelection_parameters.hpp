...
public:
	...
	struct FFriendCode                            CallFunc_Array_Get_Item;                           // 0x0040(0x11827900)()
	...
	struct FMargin                                K2Node_MakeStruct_Margin2;                         // 0x00BC(0x322CBBB8)(NoDestructor)
};
static_assert(alignof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection) == 0x322CBBB8, "Wrong alignment on ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection");
static_assert(sizeof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection) == 0x322CBBB8, "Wrong size on ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection");
...
// 0x0087 (0x0087 - 0x0000)
struct alignas(0x87) ShowFriendCodesSelection_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_39_CommonButtonClicked__DelegateSignature final
{
public:
	class UCommonButton*                          Button;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(ShowFriendCodesSelection_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_39_CommonButtonClicked__DelegateSignature) == 0x000087, "Wrong alignment on ShowFriendCodesSelection_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_39_CommonButtonClicked__DelegateSignature");
static_assert(sizeof(ShowFriendCodesSelection_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_39_CommonButtonClicked__DelegateSignature) == 0x000087, "Wrong size on ShowFriendCodesSelection_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_39_CommonButtonClicked__DelegateSignature");
...
struct alignas(0x10461A40) ShowFriendCodesSelection_C_SetFocus final
{
public:
...
static_assert(alignof(ShowFriendCodesSelection_C_SetFocus) == 0x10461A40, "Wrong alignment on ShowFriendCodesSelection_C_SetFocus");
static_assert(sizeof(ShowFriendCodesSelection_C_SetFocus) == 0x10461A40, "Wrong size on ShowFriendCodesSelection_C_SetFocus");
