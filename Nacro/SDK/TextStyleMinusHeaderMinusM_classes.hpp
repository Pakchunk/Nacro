...
static_assert(alignof(UTextStyleMinusHeaderMinusM_C) == 0x322CBBB8, "Wrong alignment on UTextStyleMinusHeaderMinusM_C");
static_assert(sizeof(UTextStyleMinusHeaderMinusM_C) == 0x322CBBB8, "Wrong size on UTextStyleMinusHeaderMinusM_C");
