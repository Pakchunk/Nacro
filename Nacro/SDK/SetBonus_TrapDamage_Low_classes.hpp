...
static_assert(alignof(USetBonus_TrapDamage_Low_C) == 0x1182E980, "Wrong alignment on USetBonus_TrapDamage_Low_C");
static_assert(sizeof(USetBonus_TrapDamage_Low_C) == 0x1182E980, "Wrong size on USetBonus_TrapDamage_Low_C");
