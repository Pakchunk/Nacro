...
static_assert(alignof(GCNL_GM_OnDmg_SpeedBuff_C_OnWhileActiveParticleSystemActivate) == 0x11821C00, "Wrong alignment on GCNL_GM_OnDmg_SpeedBuff_C_OnWhileActiveParticleSystemActivate");
static_assert(sizeof(GCNL_GM_OnDmg_SpeedBuff_C_OnWhileActiveParticleSystemActivate) == 0x11821C00, "Wrong size on GCNL_GM_OnDmg_SpeedBuff_C_OnWhileActiveParticleSystemActivate");
