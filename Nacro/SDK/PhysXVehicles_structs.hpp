...
struct alignas(0x11823D00) FVehicleEngineData final
{
public:
	struct FRuntimeFloatCurve                     TorqueCurve;                                       // 0x0000(0x11821D80)(Edit, NativeAccessSpecifierPublic)
...
static_assert(alignof(FVehicleEngineData) == 0x11823D00, "Wrong alignment on FVehicleEngineData");
static_assert(sizeof(FVehicleEngineData) == 0x11823D00, "Wrong size on FVehicleEngineData");
...
// 0x11823D00 (0x11823D00 - 0x0000)
struct alignas(0x11823D00) FVehicleGearData final
{
public:
...
static_assert(alignof(FVehicleGearData) == 0x11823D00, "Wrong alignment on FVehicleGearData");
static_assert(sizeof(FVehicleGearData) == 0x11823D00, "Wrong size on FVehicleGearData");
...
// 0x11823D00 (0x11823D00 - 0x0000)
struct alignas(0x11823D00) FTireConfigMaterialFriction final
{
public:
...
static_assert(alignof(FTireConfigMaterialFriction) == 0x11823D00, "Wrong alignment on FTireConfigMaterialFriction");
static_assert(sizeof(FTireConfigMaterialFriction) == 0x11823D00, "Wrong size on FTireConfigMaterialFriction");
...
static_assert(alignof(FVehicleAnimInstanceProxy) == 0x11828B00, "Wrong alignment on FVehicleAnimInstanceProxy");
static_assert(sizeof(FVehicleAnimInstanceProxy) == 0x11828B00, "Wrong size on FVehicleAnimInstanceProxy");

// ScriptStruct PhysXVehicles.VehicleInputRate
// 0x11823D00 (0x11823D00 - 0x0000)
struct alignas(0x11823D00) FVehicleInputRate final
{
public:
...
static_assert(alignof(FVehicleInputRate) == 0x11823D00, "Wrong alignment on FVehicleInputRate");
static_assert(sizeof(FVehicleInputRate) == 0x11823D00, "Wrong size on FVehicleInputRate");
...
// 0x11823D00 (0x11823D00 - 0x0000)
struct alignas(0x11823D00) FReplicatedVehicleState final
{
public:
...
static_assert(alignof(FReplicatedVehicleState) == 0x11823D00, "Wrong alignment on FReplicatedVehicleState");
static_assert(sizeof(FReplicatedVehicleState) == 0x11823D00, "Wrong size on FReplicatedVehicleState");
...
// 0x11823D00 (0x11823D00 - 0x0000)
struct alignas(0x11823D00) FWheelSetup final
{
public:
	...
	struct FVector                                AdditionalOffset;                                  // 0x0010(0x11821300)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FWheelSetup) == 0x11823D00, "Wrong alignment on FWheelSetup");
static_assert(sizeof(FWheelSetup) == 0x11823D00, "Wrong size on FWheelSetup");
...
// 0x11823D00 (0x11823D00 - 0x0000)
struct alignas(0x11823D00) FVehicleTransmissionData final
{
public:
...
static_assert(alignof(FVehicleTransmissionData) == 0x11823D00, "Wrong alignment on FVehicleTransmissionData");
static_assert(sizeof(FVehicleTransmissionData) == 0x11823D00, "Wrong size on FVehicleTransmissionData");
...
// 0x2CFA6180 (0x2CFA6180 - 0x0000)
struct alignas(0x2CFA6180) FVehicleDifferential4WData final
{
public:
...
static_assert(alignof(FVehicleDifferential4WData) == 0x2CFA6180, "Wrong alignment on FVehicleDifferential4WData");
static_assert(sizeof(FVehicleDifferential4WData) == 0x2CFA6180, "Wrong size on FVehicleDifferential4WData");
...
// 0x1B784400 (0x2CFA6180 - 0x11821D80)
struct alignas(0x2CFA6180) FAnimNode_WheelHandler final : public FAnimNode_SkeletalControlBase
{
};
static_assert(alignof(FAnimNode_WheelHandler) == 0x2CFA6180, "Wrong alignment on FAnimNode_WheelHandler");
static_assert(sizeof(FAnimNode_WheelHandler) == 0x2CFA6180, "Wrong size on FAnimNode_WheelHandler");
