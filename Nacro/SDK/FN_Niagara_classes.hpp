...
{
public:
	class UNiagaraEffect*                              Asset;                                                    // 0x0670(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0678(0x0010) MISSED OFFSET
	TArray<struct FNiagaraVariable>                    EffectParameterLocalOverrides;                            // 0x0688(0x0010) (Edit, ZeroConstructor)
...
{
public:
	class UCurveFloat*                                 Curve;                                                    // 0x0028(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCurveVector*                                Curve;                                                    // 0x0028(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCurveLinearColor*                           Curve;                                                    // 0x0028(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FVector2D                                   SubImageInfo;                                             // 0x0028(0x0008) (Edit, IsPlainOldData)
	bool                                               bBVelocityAligned;                                        // 0x0030(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	ENiagaraNumericOutputTypeSelectionMode             NumericOutputTypeSelectionMode;                           // 0x00A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
