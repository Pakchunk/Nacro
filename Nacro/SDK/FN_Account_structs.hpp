...
struct FOnlineAccountTexts
{
	...
	struct FText                                       FailedLoginLockoutMsg;                                    // 0x0210(0x0018) (Edit)
	struct FText                                       FailedLoginMsg;                                           // 0x0228(0x0018) (Edit)
	struct FText                                       FailedLoginTencent_UnableToSignIn;                        // 0x0240(0x0018) (Edit)
	struct FText                                       FailedStartLogin;                                         // 0x0258(0x0018) (Edit)
	struct FText                                       FounderChatExitedText;                                    // 0x0270(0x0018) (Edit)
	struct FText                                       FounderChatJoinedText;                                    // 0x0288(0x0018) (Edit)
	struct FText                                       GameDisplayName;                                          // 0x02A0(0x0018) (Edit)
	struct FText                                       GeneralLoginFailure;                                      // 0x02B8(0x0018) (Edit)
	struct FText                                       GlobalChatExitedText;                                     // 0x02D0(0x0018) (Edit)
	struct FText                                       GlobalChatJoinedText;                                     // 0x02E8(0x0018) (Edit)
	struct FText                                       HeadlessAccountFailed;                                    // 0x0300(0x0018) (Edit)
	struct FText                                       InMatchShutdownTimeWarningText;                           // 0x0318(0x0018) (Edit)
	struct FText                                       InvalidUser;                                              // 0x0330(0x0018) (Edit)
	struct FText                                       LoggedOutofMCP;                                           // 0x0348(0x0018) (Edit)
	struct FText                                       DisconnectedFromMCP;                                      // 0x0360(0x0018) (Edit)
	struct FText                                       LoggedOutReturnedToTitle;                                 // 0x0378(0x0018) (Edit)
	struct FText                                       LoggedOutSwitchedProfile;                                 // 0x0390(0x0018) (Edit)
	struct FText                                       LoggingIn;                                                // 0x03A8(0x0018) (Edit)
	struct FText                                       LoggingInConsoleAuth;                                     // 0x03C0(0x0018) (Edit)
	struct FText                                       LoggingOut;                                               // 0x03D8(0x0018) (Edit)
	struct FText                                       LoginConsole;                                             // 0x03F0(0x0018) (Edit)
	struct FText                                       LoginFailure;                                             // 0x0408(0x0018) (Edit)
	struct FText                                       Logout_Unlink;                                            // 0x0420(0x0018) (Edit)
	struct FText                                       LogoutCompleted;                                          // 0x0438(0x0018) (Edit)
	struct FText                                       LostConnection;                                           // 0x0450(0x0018) (Edit)
	struct FText                                       MCPTimeout;                                               // 0x0468(0x0018) (Edit)
	struct FText                                       NoPlayEntitlement;                                        // 0x0480(0x0018) (Edit)
	struct FText                                       NoServerAccess;                                           // 0x0498(0x0018) (Edit)
	struct FText                                       PlayAccessRevoked;                                        // 0x04B0(0x0018) (Edit)
	struct FText                                       PremiumAccountName_Default;                               // 0x04C8(0x0018) (Edit)
	struct FText                                       PremiumAccountName_PS4;                                   // 0x04E0(0x0018) (Edit)
	struct FText                                       PremiumAccountName_Switch;                                // 0x04F8(0x0018) (Edit)
	struct FText                                       PremiumAccountName_XboxOne;                               // 0x0510(0x0018) (Edit)
	struct FText                                       RedeemOfflinePurchases;                                   // 0x0528(0x0018) (Edit)
	struct FText                                       ServiceDowntime;                                          // 0x0540(0x0018) (Edit)
	struct FText                                       SignInCompleting;                                         // 0x0558(0x0018) (Edit)
	struct FText                                       SignIntoConsoleServices;                                  // 0x0570(0x0018) (Edit)
	struct FText                                       TokenExpired;                                             // 0x0588(0x0018) (Edit)
	struct FText                                       UnableToConnect;                                          // 0x05A0(0x0018) (Edit)
	struct FText                                       UnableToJoinWaitingRoomLoginQueue;                        // 0x05B8(0x0018) (Edit)
	struct FText                                       UnexpectedConsoleAuthFailure;                             // 0x05D0(0x0018) (Edit)
	struct FText                                       UnlinkConsoleFailed;                                      // 0x05E8(0x0018) (Edit)
	struct FText                                       UserLoginFailed;                                          // 0x0600(0x0018) (Edit)
	struct FText                                       WaitingRoom;                                              // 0x0618(0x0018) (Edit)
	struct FText                                       WaitingRoomError;                                         // 0x0630(0x0018) (Edit)
	struct FText                                       WaitingRoomFailure;                                       // 0x0648(0x0018) (Edit)
	struct FText                                       WaitingRoomWaiting;                                       // 0x0660(0x0018) (Edit)
	struct FOnlineAccountTexts_FailedLoginConsole      FailedLoginConsole;                                       // 0x0678(0x0138) (Edit)
};
