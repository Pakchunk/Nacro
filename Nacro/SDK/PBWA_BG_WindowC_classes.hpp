...
static_assert(alignof(APBWA_BG_WindowC_C) == 0x000010, "Wrong alignment on APBWA_BG_WindowC_C");
static_assert(sizeof(APBWA_BG_WindowC_C) == 0x0010B0, "Wrong size on APBWA_BG_WindowC_C");
