...
public:
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x002C(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(AnimNotify_PlayForceFeedback_C_Received_Notify) == 0x11821300, "Wrong alignment on AnimNotify_PlayForceFeedback_C_Received_Notify");
static_assert(sizeof(AnimNotify_PlayForceFeedback_C_Received_Notify) == 0x11821300, "Wrong size on AnimNotify_PlayForceFeedback_C_Received_Notify");
