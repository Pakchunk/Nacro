...
struct alignas(0x740053) Results_StatsSubtypeBox_C_ExecuteUbergraph_Results_StatsSubtypeBox final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Results_StatsSubtypeBox_C_ExecuteUbergraph_Results_StatsSubtypeBox) == 0x740053, "Wrong alignment on Results_StatsSubtypeBox_C_ExecuteUbergraph_Results_StatsSubtypeBox");
static_assert(sizeof(Results_StatsSubtypeBox_C_ExecuteUbergraph_Results_StatsSubtypeBox) == 0x740053, "Wrong size on Results_StatsSubtypeBox_C_ExecuteUbergraph_Results_StatsSubtypeBox");
...
public:
	...
	struct FLinearColor                           CallFunc_Multiply_LinearColorFloat_ReturnValue;    // 0x0030(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortScoreStylingInfo                  CallFunc_GetScoreStylingData_ScoreStylingInfo;     // 0x0040(0x11821780)()
	bool                                          CallFunc_GetScoreStylingData_ReturnValue;          // 0x03C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_3C9[0x7];                                      // 0x03C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateColor                            K2Node_MakeStruct_SlateColor;                      // 0x03D0(0x322CBBB8)()
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x03F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Results_StatsSubtypeBox_C_InitializeScoreType) == 0x322CBBB8, "Wrong alignment on Results_StatsSubtypeBox_C_InitializeScoreType");
static_assert(sizeof(Results_StatsSubtypeBox_C_InitializeScoreType) == 0x322CBBB8, "Wrong size on Results_StatsSubtypeBox_C_InitializeScoreType");
