...
struct alignas(0x33DB3D00) FEngineServiceAuthGrant final
{
public:
...
static_assert(alignof(FEngineServiceAuthGrant) == 0x33DB3D00, "Wrong alignment on FEngineServiceAuthGrant");
static_assert(sizeof(FEngineServiceAuthGrant) == 0x33DB3D00, "Wrong size on FEngineServiceAuthGrant");
...
// 0x33DB3D00 (0x33DB3D00 - 0x0000)
struct alignas(0x33DB3D00) FEngineServiceNotification final
{
public:
...
static_assert(alignof(FEngineServiceNotification) == 0x33DB3D00, "Wrong alignment on FEngineServiceNotification");
static_assert(sizeof(FEngineServiceNotification) == 0x33DB3D00, "Wrong size on FEngineServiceNotification");
...
// 0x33DB3D00 (0x33DB3D00 - 0x0000)
struct alignas(0x33DB3D00) FEngineServiceAuthDeny final
{
public:
	class FString                                 UserName;                                          // 0x0000(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 UserToDeny;                                        // 0x0010(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEngineServiceAuthDeny) == 0x33DB3D00, "Wrong alignment on FEngineServiceAuthDeny");
static_assert(sizeof(FEngineServiceAuthDeny) == 0x33DB3D00, "Wrong size on FEngineServiceAuthDeny");
...
// 0x33DB3D00 (0x33DB3D00 - 0x0000)
struct alignas(0x33DB3D00) FEngineServiceTerminate final
{
public:
	class FString                                 UserName;                                          // 0x0000(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEngineServiceTerminate) == 0x33DB3D00, "Wrong alignment on FEngineServiceTerminate");
static_assert(sizeof(FEngineServiceTerminate) == 0x33DB3D00, "Wrong size on FEngineServiceTerminate");
...
// 0x33DB3D00 (0x33DB3D00 - 0x0000)
struct alignas(0x33DB3D00) FEngineServiceExecuteCommand final
{
public:
...
static_assert(alignof(FEngineServiceExecuteCommand) == 0x33DB3D00, "Wrong alignment on FEngineServiceExecuteCommand");
static_assert(sizeof(FEngineServiceExecuteCommand) == 0x33DB3D00, "Wrong size on FEngineServiceExecuteCommand");
...
// 0x11829D00 (0x11829D00 - 0x0000)
struct alignas(0x11829D00) FEngineServicePing final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEngineServicePing) == 0x11829D00, "Wrong alignment on FEngineServicePing");
static_assert(sizeof(FEngineServicePing) == 0x11829D00, "Wrong size on FEngineServicePing");

// ScriptStruct EngineMessages.EngineServicePong
// 0x11829D00 (0x11829D00 - 0x0000)
struct alignas(0x11829D00) FEngineServicePong final
{
public:
	...
	struct FGuid                                  InstanceId;                                        // 0x0018(0x11821300)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InstanceType;                                      // 0x0028(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  SessionId;                                         // 0x0038(0x11821300)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FEngineServicePong) == 0x11829D00, "Wrong alignment on FEngineServicePong");
static_assert(sizeof(FEngineServicePong) == 0x11829D00, "Wrong size on FEngineServicePong");
