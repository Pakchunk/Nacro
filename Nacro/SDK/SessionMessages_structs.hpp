...
// 0x1182E380 (0x1182E380 - 0x0000)
struct alignas(0x1182E380) FSessionServicePong final
{
public:
	...
	struct FGuid                                  InstanceId;                                        // 0x0028(0x11821300)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FGuid                                  SessionId;                                         // 0x0060(0x11821300)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FSessionServicePong) == 0x1182E380, "Wrong alignment on FSessionServicePong");
static_assert(sizeof(FSessionServicePong) == 0x1182E380, "Wrong size on FSessionServicePong");
...
struct alignas(0x33DB4000) FSessionServiceLogUnsubscribe final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServiceLogUnsubscribe) == 0x33DB4000, "Wrong alignment on FSessionServiceLogUnsubscribe");
static_assert(sizeof(FSessionServiceLogUnsubscribe) == 0x33DB4000, "Wrong size on FSessionServiceLogUnsubscribe");

// ScriptStruct SessionMessages.SessionServiceLogSubscribe
// 0x33DB4000 (0x33DB4000 - 0x0000)
struct alignas(0x33DB4000) FSessionServiceLogSubscribe final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServiceLogSubscribe) == 0x33DB4000, "Wrong alignment on FSessionServiceLogSubscribe");
static_assert(sizeof(FSessionServiceLogSubscribe) == 0x33DB4000, "Wrong size on FSessionServiceLogSubscribe");

// ScriptStruct SessionMessages.SessionServiceLog
// 0x33DB4000 (0x33DB4000 - 0x0000)
struct alignas(0x33DB4000) FSessionServiceLog final
{
public:
...
static_assert(alignof(FSessionServiceLog) == 0x33DB4000, "Wrong alignment on FSessionServiceLog");
static_assert(sizeof(FSessionServiceLog) == 0x33DB4000, "Wrong size on FSessionServiceLog");
...
// 0x1182E380 (0x1182E380 - 0x0000)
struct alignas(0x1182E380) FSessionServicePing final
{
public:
	class FString                                 UserName;                                          // 0x0000(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSessionServicePing) == 0x1182E380, "Wrong alignment on FSessionServicePing");
static_assert(sizeof(FSessionServicePing) == 0x1182E380, "Wrong size on FSessionServicePing");
