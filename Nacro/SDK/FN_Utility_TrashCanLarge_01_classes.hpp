...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Utility_TrashCanLarge_01.Utility_TrashCanLarge_01_C");
		return ptr;
	}
	...
	void OnLoot();
	void ExecuteUbergraph_Utility_TrashCanLarge_01(int EntryPoint);
};
