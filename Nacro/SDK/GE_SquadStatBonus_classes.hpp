...
static_assert(alignof(UGE_SquadStatBonus_C) == 0x1182E980, "Wrong alignment on UGE_SquadStatBonus_C");
static_assert(sizeof(UGE_SquadStatBonus_C) == 0x1182E980, "Wrong size on UGE_SquadStatBonus_C");
