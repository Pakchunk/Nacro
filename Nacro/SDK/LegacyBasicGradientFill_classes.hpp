...
static_assert(alignof(ULegacyBasicGradientFill_C) == 0x322CBBB8, "Wrong alignment on ULegacyBasicGradientFill_C");
static_assert(sizeof(ULegacyBasicGradientFill_C) == 0x322CBBB8, "Wrong size on ULegacyBasicGradientFill_C");
