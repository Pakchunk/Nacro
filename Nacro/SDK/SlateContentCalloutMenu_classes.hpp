...
public:
	...
	class UFortLegacySlateBridgeWidget*           mSlate_Widget__Menu_Content;                       // 0x0238(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(USlateContentCalloutMenu_C, mSlate_Widget__Menu_Content) == 0x000238, "Member 'USlateContentCalloutMenu_C::mSlate_Widget__Menu_Content' has a wrong offset!");
