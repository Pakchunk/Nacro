...
// 0x51895F00 (0x51895F00 - 0x0000)
struct alignas(0x51895F00) ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  K2Node_CustomEvent_FailedReason;                   // 0x0008(0x11821C00)()
...
static_assert(alignof(ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget) == 0x51895F00, "Wrong alignment on ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget");
static_assert(sizeof(ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget) == 0x51895F00, "Wrong size on ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget");
...
static_assert(alignof(ReticleStatusWidget_C_OnUnableToPerformAction) == 0x11821C00, "Wrong alignment on ReticleStatusWidget_C_OnUnableToPerformAction");
static_assert(sizeof(ReticleStatusWidget_C_OnUnableToPerformAction) == 0x11821C00, "Wrong size on ReticleStatusWidget_C_OnUnableToPerformAction");
