...
public:
	...
	struct FGameplayEffectSpecHandle              CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue; // 0x0008(0x11821C00)()
	struct FGameplayEffectSpecHandle              CallFunc_SetupDebilitationTraining_EffectspecOutInstant; // 0x0020(0x11821C00)()
	struct FGameplayEffectSpecHandle              CallFunc_SetupDebilitationTraining_EffectspecOutDuration; // 0x0038(0x11821C00)()
	struct FGameplayEffectSpecHandle              CallFunc_SetupAppliedEffect_EffectspecHandleOut;   // 0x0050(0x11821C00)()
	...
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x00D0(0x11822200)(ConstParm)
	struct FGameplayAbilityTargetDataHandle       CallFunc_SetupGameplayEffect_Target_Data;          // 0x0178(0x11821C00)()
	...
	struct FGameplayEffectSpecHandle              CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue2; // 0x01B8(0x11821C00)()
	struct FGameplayEffectSpecHandle              CallFunc_SetupAppliedEffect_EffectspecHandleOut2;  // 0x01D0(0x11821C00)()
...
static_assert(alignof(GA_Commando_DebilitatingShots_C_ExecuteUbergraph_GA_Commando_DebilitatingShots) == 0x11822200, "Wrong alignment on GA_Commando_DebilitatingShots_C_ExecuteUbergraph_GA_Commando_DebilitatingShots");
static_assert(sizeof(GA_Commando_DebilitatingShots_C_ExecuteUbergraph_GA_Commando_DebilitatingShots) == 0x11822200, "Wrong size on GA_Commando_DebilitatingShots_C_ExecuteUbergraph_GA_Commando_DebilitatingShots");
...
static_assert(alignof(GA_Commando_DebilitatingShots_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GA_Commando_DebilitatingShots_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GA_Commando_DebilitatingShots_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GA_Commando_DebilitatingShots_C_K2_ActivateAbilityFromEvent");
...
{
public:
	struct FGameplayTag                           EventTag;                                          // 0x0000(0x11821D80)(Parm, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAbilityTargetDataHandle       Target_Data;                                       // 0x0018(0x11821C00)(Parm, OutParm)
	...
	struct FGameplayAbilityTargetDataHandle       CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x0048(0x11821C00)()
	bool                                          CallFunc_MatchesTag_ReturnValue;                   // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(GA_Commando_DebilitatingShots_C_SetupGameplayEffect) == 0x11821D80, "Wrong alignment on GA_Commando_DebilitatingShots_C_SetupGameplayEffect");
static_assert(sizeof(GA_Commando_DebilitatingShots_C_SetupGameplayEffect) == 0x11821D80, "Wrong size on GA_Commando_DebilitatingShots_C_SetupGameplayEffect");
...
public:
	...
	struct FGameplayEffectSpecHandle              EffectSpecHandle;                                  // 0x0010(0x11821C00)(Parm)
	struct FGameplayEffectSpecHandle              EffectspecHandleOut;                               // 0x0028(0x11821C00)(Parm, OutParm)
	struct FGameplayEffectSpecHandle              CallFunc_AssignSetByCallerMagnitude_ReturnValue;   // 0x0040(0x11821C00)()
	struct FGameplayEffectSpecHandle              CallFunc_AssignSetByCallerMagnitude_ReturnValue2;  // 0x0058(0x11821C00)()
	struct FGameplayEffectSpecHandle              CallFunc_SetStackCount_ReturnValue;                // 0x0070(0x11821C00)()
};
static_assert(alignof(GA_Commando_DebilitatingShots_C_SetupAppliedEffect) == 0x11821C00, "Wrong alignment on GA_Commando_DebilitatingShots_C_SetupAppliedEffect");
static_assert(sizeof(GA_Commando_DebilitatingShots_C_SetupAppliedEffect) == 0x11821C00, "Wrong size on GA_Commando_DebilitatingShots_C_SetupAppliedEffect");
...
{
public:
	struct FGameplayEffectSpecHandle              EffectspecOutInstant;                              // 0x0000(0x11821C00)(Parm, OutParm)
	struct FGameplayEffectSpecHandle              EffectspecOutDuration;                             // 0x0018(0x11821C00)(Parm, OutParm)
	struct FGameplayEffectSpecHandle              CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue; // 0x0030(0x11821C00)()
	struct FGameplayEffectSpecHandle              CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue2; // 0x0048(0x11821C00)()
};
static_assert(alignof(GA_Commando_DebilitatingShots_C_SetupDebilitationTraining) == 0x11821C00, "Wrong alignment on GA_Commando_DebilitatingShots_C_SetupDebilitationTraining");
static_assert(sizeof(GA_Commando_DebilitatingShots_C_SetupDebilitationTraining) == 0x11821C00, "Wrong size on GA_Commando_DebilitatingShots_C_SetupDebilitationTraining");
...
struct alignas(0x740065) GA_Commando_DebilitatingShots_C_SetupAbility final
{
public:
...
static_assert(alignof(GA_Commando_DebilitatingShots_C_SetupAbility) == 0x740065, "Wrong alignment on GA_Commando_DebilitatingShots_C_SetupAbility");
static_assert(sizeof(GA_Commando_DebilitatingShots_C_SetupAbility) == 0x740065, "Wrong size on GA_Commando_DebilitatingShots_C_SetupAbility");
...
static_assert(alignof(GA_Commando_DebilitatingShots_C_K2_ShouldAbilityRespondToEvent) == 0x11822200, "Wrong alignment on GA_Commando_DebilitatingShots_C_K2_ShouldAbilityRespondToEvent");
static_assert(sizeof(GA_Commando_DebilitatingShots_C_K2_ShouldAbilityRespondToEvent) == 0x11822200, "Wrong size on GA_Commando_DebilitatingShots_C_K2_ShouldAbilityRespondToEvent");
