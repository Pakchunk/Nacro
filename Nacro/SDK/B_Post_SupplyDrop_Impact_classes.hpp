...
static_assert(alignof(AB_Post_SupplyDrop_Impact_C) == 0x11821D80, "Wrong alignment on AB_Post_SupplyDrop_Impact_C");
static_assert(sizeof(AB_Post_SupplyDrop_Impact_C) == 0x11821D80, "Wrong size on AB_Post_SupplyDrop_Impact_C");
