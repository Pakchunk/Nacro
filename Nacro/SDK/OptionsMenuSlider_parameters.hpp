...
struct alignas(0xE4) OptionsMenuSlider_C_SliderChanged__DelegateSignature final
{
public:
	float                                         Slider_Value;                                      // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(OptionsMenuSlider_C_SliderChanged__DelegateSignature) == 0x0000E4, "Wrong alignment on OptionsMenuSlider_C_SliderChanged__DelegateSignature");
static_assert(sizeof(OptionsMenuSlider_C_SliderChanged__DelegateSignature) == 0x0000E4, "Wrong size on OptionsMenuSlider_C_SliderChanged__DelegateSignature");
...
static_assert(alignof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider) == 0x11829280, "Wrong alignment on OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider");
static_assert(sizeof(OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider) == 0x11829280, "Wrong size on OptionsMenuSlider_C_ExecuteUbergraph_OptionsMenuSlider");
...
struct alignas(0x24) OptionsMenuSlider_C_BndEvt__MenuSlider_K2Node_ComponentBoundEvent_124_OnFloatValueChangedEvent__DelegateSignature final
{
public:
	float                                         Value;                                             // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(OptionsMenuSlider_C_BndEvt__MenuSlider_K2Node_ComponentBoundEvent_124_OnFloatValueChangedEvent__DelegateSignature) == 0x000024, "Wrong alignment on OptionsMenuSlider_C_BndEvt__MenuSlider_K2Node_ComponentBoundEvent_124_OnFloatValueChangedEvent__DelegateSignature");
static_assert(sizeof(OptionsMenuSlider_C_BndEvt__MenuSlider_K2Node_ComponentBoundEvent_124_OnFloatValueChangedEvent__DelegateSignature) == 0x000024, "Wrong size on OptionsMenuSlider_C_BndEvt__MenuSlider_K2Node_ComponentBoundEvent_124_OnFloatValueChangedEvent__DelegateSignature");
...
static_assert(alignof(OptionsMenuSlider_C_OnMouseEnter) == 0x11829280, "Wrong alignment on OptionsMenuSlider_C_OnMouseEnter");
static_assert(sizeof(OptionsMenuSlider_C_OnMouseEnter) == 0x11829280, "Wrong size on OptionsMenuSlider_C_OnMouseEnter");
...
static_assert(alignof(OptionsMenuSlider_C_OnMouseLeave) == 0x11829280, "Wrong alignment on OptionsMenuSlider_C_OnMouseLeave");
static_assert(sizeof(OptionsMenuSlider_C_OnMouseLeave) == 0x11829280, "Wrong size on OptionsMenuSlider_C_OnMouseLeave");
