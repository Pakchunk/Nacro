...
public:
	...
	struct FDataTableRowHandle                    BackInputAction;                                   // 0x0410(0x1182EB00)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(alignof(UBP_FortExpeditionPickVehicleWidget_C) == 0x322CBBB8, "Wrong alignment on UBP_FortExpeditionPickVehicleWidget_C");
static_assert(sizeof(UBP_FortExpeditionPickVehicleWidget_C) == 0x322CBBB8, "Wrong size on UBP_FortExpeditionPickVehicleWidget_C");
