...
static_assert(alignof(UAccountBonuses_C) == 0x322CBBB8, "Wrong alignment on UAccountBonuses_C");
static_assert(sizeof(UAccountBonuses_C) == 0x322CBBB8, "Wrong size on UAccountBonuses_C");
