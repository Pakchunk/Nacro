...
public:
	...
	class UFortQuestItem*                              RequiredQuest;                                            // 0x0280(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FText                                       PinnedQuestSingularText;                                  // 0x0288(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       PinnedQuestsPluralText;                                   // 0x02A0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	int                                                MaxDisplayedQuestUpdates;                                 // 0x02C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FTimerHandle                                TryDisplayNextUpdateTimerHandle;                          // 0x02E0(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	int                                                MaxDisplayedQuestObjectives;                              // 0x02E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
