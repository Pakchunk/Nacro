...
public:
	...
	struct FBox                                   Box;                                               // 0x0010(0x11821300)(Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FoliageStatistics_FoliageOverlappingBoxCount) == 0x11821300, "Wrong alignment on FoliageStatistics_FoliageOverlappingBoxCount");
static_assert(sizeof(FoliageStatistics_FoliageOverlappingBoxCount) == 0x11821300, "Wrong size on FoliageStatistics_FoliageOverlappingBoxCount");
...
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	const class UStaticMesh*                      StaticMesh;                                        // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CenterPosition;                                    // 0x0010(0x11821300)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FoliageStatistics_FoliageOverlappingSphereCount) == 0x11821300, "Wrong alignment on FoliageStatistics_FoliageOverlappingSphereCount");
static_assert(sizeof(FoliageStatistics_FoliageOverlappingSphereCount) == 0x11821300, "Wrong size on FoliageStatistics_FoliageOverlappingSphereCount");
...
public:
	...
	struct FHitResult                             OverlapInfo;                                       // 0x0020(0x11827600)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(InteractiveFoliageActor_CapsuleTouched) == 0x11821D80, "Wrong alignment on InteractiveFoliageActor_CapsuleTouched");
static_assert(sizeof(InteractiveFoliageActor_CapsuleTouched) == 0x11821D80, "Wrong size on InteractiveFoliageActor_CapsuleTouched");
...
struct alignas(0x2D633D80) ProceduralFoliageSpawner_Simulate final
{
public:
...
static_assert(alignof(ProceduralFoliageSpawner_Simulate) == 0x2D633D80, "Wrong alignment on ProceduralFoliageSpawner_Simulate");
static_assert(sizeof(ProceduralFoliageSpawner_Simulate) == 0x2D633D80, "Wrong size on ProceduralFoliageSpawner_Simulate");
