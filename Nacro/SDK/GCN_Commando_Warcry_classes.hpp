...
static_assert(alignof(AGCN_Commando_Warcry_C) == 0x11821D80, "Wrong alignment on AGCN_Commando_Warcry_C");
static_assert(sizeof(AGCN_Commando_Warcry_C) == 0x11821D80, "Wrong size on AGCN_Commando_Warcry_C");
