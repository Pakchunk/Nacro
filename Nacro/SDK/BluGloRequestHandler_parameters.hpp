...
static_assert(alignof(BluGloRequestHandler_C_OnBluGloQueryFinished__DelegateSignature) == 0x11821300, "Wrong alignment on BluGloRequestHandler_C_OnBluGloQueryFinished__DelegateSignature");
static_assert(sizeof(BluGloRequestHandler_C_OnBluGloQueryFinished__DelegateSignature) == 0x11821300, "Wrong size on BluGloRequestHandler_C_OnBluGloQueryFinished__DelegateSignature");
...
public:
	...
	struct FVector                                K2Node_CustomEvent_LocationToSpawnFromIfActorInvalid; // 0x0038(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler) == 0x11821300, "Wrong alignment on BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler");
static_assert(sizeof(BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler) == 0x11821300, "Wrong size on BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler");
...
static_assert(alignof(BluGloRequestHandler_C_InitializeBluGloRequestHandler) == 0x11821300, "Wrong alignment on BluGloRequestHandler_C_InitializeBluGloRequestHandler");
static_assert(sizeof(BluGloRequestHandler_C_InitializeBluGloRequestHandler) == 0x11821300, "Wrong size on BluGloRequestHandler_C_InitializeBluGloRequestHandler");
