...
// 0x4C415740 (0x4C415740 - 0x0000)
struct alignas(0x4C415740) HordeWaveModifiersTile_C_ExecuteUbergraph_HordeWaveModifiersTile final
{
public:
...
static_assert(alignof(HordeWaveModifiersTile_C_ExecuteUbergraph_HordeWaveModifiersTile) == 0x4C415740, "Wrong alignment on HordeWaveModifiersTile_C_ExecuteUbergraph_HordeWaveModifiersTile");
static_assert(sizeof(HordeWaveModifiersTile_C_ExecuteUbergraph_HordeWaveModifiersTile) == 0x4C415740, "Wrong size on HordeWaveModifiersTile_C_ExecuteUbergraph_HordeWaveModifiersTile");
...
struct alignas(0x6F004A) HordeWaveModifiersTile_C_SetData final
{
public:
	class UObject*                                InData;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(HordeWaveModifiersTile_C_SetData) == 0x6F004A, "Wrong alignment on HordeWaveModifiersTile_C_SetData");
static_assert(sizeof(HordeWaveModifiersTile_C_SetData) == 0x6F004A, "Wrong size on HordeWaveModifiersTile_C_SetData");
...
// 0x55D58900 (0x55D58900 - 0x0000)
struct alignas(0x55D58900) HordeWaveModifiersTile_C_SetModifierItem final
{
public:
...
static_assert(alignof(HordeWaveModifiersTile_C_SetModifierItem) == 0x55D58900, "Wrong alignment on HordeWaveModifiersTile_C_SetModifierItem");
static_assert(sizeof(HordeWaveModifiersTile_C_SetModifierItem) == 0x55D58900, "Wrong size on HordeWaveModifiersTile_C_SetModifierItem");
