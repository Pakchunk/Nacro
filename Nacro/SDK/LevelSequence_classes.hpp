...
public:
	...
	struct FLevelSequenceObjectReferenceMap       ObjectReferences;                                  // 0x02E0(0x1182B500)(NativeAccessSpecifierPrivate)
...
static_assert(alignof(ULevelSequence) == 0x1182B500, "Wrong alignment on ULevelSequence");
static_assert(sizeof(ULevelSequence) == 0x1182B500, "Wrong size on ULevelSequence");
...
static_assert(alignof(ULevelSequencePlayer) == 0x11828980, "Wrong alignment on ULevelSequencePlayer");
static_assert(sizeof(ULevelSequencePlayer) == 0x11828980, "Wrong size on ULevelSequencePlayer");
...
public:
	...
	struct FStringClassReference                  BurnInClass;                                       // 0x0030(0x11821300)(Edit, NativeAccessSpecifierPublic)
...
static_assert(alignof(ULevelSequenceBurnInOptions) == 0x11821300, "Wrong alignment on ULevelSequenceBurnInOptions");
static_assert(sizeof(ULevelSequenceBurnInOptions) == 0x11821300, "Wrong size on ULevelSequenceBurnInOptions");
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x0398(0x11828980)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FStringAssetReference                  LevelSequence;                                     // 0x03C8(0x11821300)(Edit, BlueprintVisible, BlueprintReadOnly, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(ALevelSequenceActor) == 0x11828980, "Wrong alignment on ALevelSequenceActor");
static_assert(sizeof(ALevelSequenceActor) == 0x11828980, "Wrong size on ALevelSequenceActor");
...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x0230(0x1182B800)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(alignof(ULevelSequenceBurnIn) == 0x322CBBB8, "Wrong alignment on ULevelSequenceBurnIn");
static_assert(sizeof(ULevelSequenceBurnIn) == 0x322CBBB8, "Wrong size on ULevelSequenceBurnIn");
