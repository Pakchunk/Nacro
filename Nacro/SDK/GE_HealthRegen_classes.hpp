...
static_assert(alignof(UGE_HealthRegen_C) == 0x1182E980, "Wrong alignment on UGE_HealthRegen_C");
static_assert(sizeof(UGE_HealthRegen_C) == 0x1182E980, "Wrong size on UGE_HealthRegen_C");
