...
static_assert(alignof(UResults_BadgeLoot_C) == 0x322CBBB8, "Wrong alignment on UResults_BadgeLoot_C");
static_assert(sizeof(UResults_BadgeLoot_C) == 0x322CBBB8, "Wrong size on UResults_BadgeLoot_C");
