...
static_assert(alignof(ItemRatingIndicator_C_ExecuteUbergraph_ItemRatingIndicator) == 0x11827900, "Wrong alignment on ItemRatingIndicator_C_ExecuteUbergraph_ItemRatingIndicator");
static_assert(sizeof(ItemRatingIndicator_C_ExecuteUbergraph_ItemRatingIndicator) == 0x11827900, "Wrong size on ItemRatingIndicator_C_ExecuteUbergraph_ItemRatingIndicator");
