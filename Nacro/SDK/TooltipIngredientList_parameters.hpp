...
struct alignas(0x28) TooltipIngredientList_C_ExecuteUbergraph_TooltipIngredientList final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(TooltipIngredientList_C_ExecuteUbergraph_TooltipIngredientList) == 0x000028, "Wrong alignment on TooltipIngredientList_C_ExecuteUbergraph_TooltipIngredientList");
static_assert(sizeof(TooltipIngredientList_C_ExecuteUbergraph_TooltipIngredientList) == 0x000028, "Wrong size on TooltipIngredientList_C_ExecuteUbergraph_TooltipIngredientList");
...
public:
	...
	struct FSchematicRequirement                  CallFunc_Array_Get_Item;                           // 0x0028(0x11821780)(NoDestructor)
	...
	struct FMargin                                K2Node_MakeStruct_Margin;                          // 0x0040(0x322CBBB8)(NoDestructor)
...
static_assert(alignof(TooltipIngredientList_C_Refresh) == 0x322CBBB8, "Wrong alignment on TooltipIngredientList_C_Refresh");
static_assert(sizeof(TooltipIngredientList_C_Refresh) == 0x322CBBB8, "Wrong size on TooltipIngredientList_C_Refresh");
