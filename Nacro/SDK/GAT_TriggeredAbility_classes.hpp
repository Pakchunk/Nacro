...
class alignas(0x1182EB00) UGAT_TriggeredAbility_C : public UFortGameplayAbility
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0A40(0x11821D80)(Transient, DuplicateTransient)
	struct FGameplayTag                           TC_AbilitiesGenericTriggeredAbilityActivate;       // 0x0A48(0x11821D80)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
#pragma pack(pop)
static_assert(alignof(UGAT_TriggeredAbility_C) == 0x1182EB00, "Wrong alignment on UGAT_TriggeredAbility_C");
static_assert(sizeof(UGAT_TriggeredAbility_C) == 0x1182EB00, "Wrong size on UGAT_TriggeredAbility_C");
