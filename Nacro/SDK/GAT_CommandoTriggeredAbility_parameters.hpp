...
public:
	...
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x0048(0x11822200)(ConstParm)
	...
	struct FGameplayEventData                     K2Node_MakeStruct_GameplayEventData;               // 0x0130(0x11822200)()
};
static_assert(alignof(GAT_CommandoTriggeredAbility_C_ExecuteUbergraph_GAT_CommandoTriggeredAbility) == 0x11822200, "Wrong alignment on GAT_CommandoTriggeredAbility_C_ExecuteUbergraph_GAT_CommandoTriggeredAbility");
static_assert(sizeof(GAT_CommandoTriggeredAbility_C_ExecuteUbergraph_GAT_CommandoTriggeredAbility) == 0x11822200, "Wrong size on GAT_CommandoTriggeredAbility_C_ExecuteUbergraph_GAT_CommandoTriggeredAbility");
...
static_assert(alignof(GAT_CommandoTriggeredAbility_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GAT_CommandoTriggeredAbility_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GAT_CommandoTriggeredAbility_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GAT_CommandoTriggeredAbility_C_K2_ActivateAbilityFromEvent");
