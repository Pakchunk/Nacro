...
struct alignas(0x10000) Credits_C_ExecuteUbergraph_Credits final
{
public:
...
static_assert(alignof(Credits_C_ExecuteUbergraph_Credits) == 0x010000, "Wrong alignment on Credits_C_ExecuteUbergraph_Credits");
static_assert(sizeof(Credits_C_ExecuteUbergraph_Credits) == 0x010000, "Wrong size on Credits_C_ExecuteUbergraph_Credits");
...
static_assert(alignof(Credits_C_ToggleScrollTimer) == 0x11821D80, "Wrong alignment on Credits_C_ToggleScrollTimer");
static_assert(sizeof(Credits_C_ToggleScrollTimer) == 0x11821D80, "Wrong size on Credits_C_ToggleScrollTimer");
...
struct alignas(0x540065) Credits_C_ScrollCredits final
{
public:
...
static_assert(alignof(Credits_C_ScrollCredits) == 0x540065, "Wrong alignment on Credits_C_ScrollCredits");
static_assert(sizeof(Credits_C_ScrollCredits) == 0x540065, "Wrong size on Credits_C_ScrollCredits");
