...
static_assert(alignof(WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile) == 0x11827900, "Wrong alignment on WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile");
static_assert(sizeof(WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile) == 0x11827900, "Wrong size on WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile");
...
struct alignas(0x590) WaveModifiersTile_C_SetData final
{
public:
	class UObject*                                InData;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WaveModifiersTile_C_SetData) == 0x000590, "Wrong alignment on WaveModifiersTile_C_SetData");
static_assert(sizeof(WaveModifiersTile_C_SetData) == 0x000590, "Wrong size on WaveModifiersTile_C_SetData");
...
public:
	...
	struct FSlateBrush                            CallFunc_GetItemSmallPreviewImageBrush_ReturnValue; // 0x0010(0x322CBBB8)()
...
static_assert(alignof(WaveModifiersTile_C_SetModifierItem) == 0x11827900, "Wrong alignment on WaveModifiersTile_C_SetModifierItem");
static_assert(sizeof(WaveModifiersTile_C_SetModifierItem) == 0x11827900, "Wrong size on WaveModifiersTile_C_SetModifierItem");
