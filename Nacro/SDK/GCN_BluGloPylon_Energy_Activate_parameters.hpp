...
static_assert(alignof(GCN_BluGloPylon_Energy_Activate_C_OnStartParticleSystemSpawned) == 0x11821C00, "Wrong alignment on GCN_BluGloPylon_Energy_Activate_C_OnStartParticleSystemSpawned");
static_assert(sizeof(GCN_BluGloPylon_Energy_Activate_C_OnStartParticleSystemSpawned) == 0x11821C00, "Wrong size on GCN_BluGloPylon_Energy_Activate_C_OnStartParticleSystemSpawned");
