...
class alignas(0x11821D80) AB_PlayerHealthDamage_CameraLensEffect_C : public AEmitterCameraLensEffectBase
{
public:
...
#pragma pack(pop)
static_assert(alignof(AB_PlayerHealthDamage_CameraLensEffect_C) == 0x11821D80, "Wrong alignment on AB_PlayerHealthDamage_CameraLensEffect_C");
static_assert(sizeof(AB_PlayerHealthDamage_CameraLensEffect_C) == 0x11821D80, "Wrong size on AB_PlayerHealthDamage_CameraLensEffect_C");
