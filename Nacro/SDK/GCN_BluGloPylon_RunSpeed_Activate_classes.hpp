...
static_assert(alignof(AGCN_BluGloPylon_RunSpeed_Activate_C) == 0x11821D80, "Wrong alignment on AGCN_BluGloPylon_RunSpeed_Activate_C");
static_assert(sizeof(AGCN_BluGloPylon_RunSpeed_Activate_C) == 0x11821D80, "Wrong size on AGCN_BluGloPylon_RunSpeed_Activate_C");
