...
static_assert(alignof(UGET_PeriodicPhysicalDamage_C) == 0x1182E980, "Wrong alignment on UGET_PeriodicPhysicalDamage_C");
static_assert(sizeof(UGET_PeriodicPhysicalDamage_C) == 0x1182E980, "Wrong size on UGET_PeriodicPhysicalDamage_C");
