...
static_assert(alignof(GA_Commando_Survivalist_C_ExecuteUbergraph_GA_Commando_Survivalist) == 0x11822200, "Wrong alignment on GA_Commando_Survivalist_C_ExecuteUbergraph_GA_Commando_Survivalist");
static_assert(sizeof(GA_Commando_Survivalist_C_ExecuteUbergraph_GA_Commando_Survivalist) == 0x11822200, "Wrong size on GA_Commando_Survivalist_C_ExecuteUbergraph_GA_Commando_Survivalist");
...
static_assert(alignof(GA_Commando_Survivalist_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GA_Commando_Survivalist_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GA_Commando_Survivalist_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GA_Commando_Survivalist_C_K2_ActivateAbilityFromEvent");
...
public:
	...
	struct FGameplayEffectSpecHandle              CallFunc_AssignSetByCallerMagnitude_ReturnValue;   // 0x0028(0x11821C00)()
	struct FActiveGameplayEffectHandle            CallFunc_K2_ApplyGameplayEffectSpecToOwner_ReturnValue; // 0x0040(0x11821C00)(NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(GA_Commando_Survivalist_C_ApplyHeal) == 0x11821C00, "Wrong alignment on GA_Commando_Survivalist_C_ApplyHeal");
static_assert(sizeof(GA_Commando_Survivalist_C_ApplyHeal) == 0x11821C00, "Wrong size on GA_Commando_Survivalist_C_ApplyHeal");
...
struct alignas(0x61) GA_Commando_Survivalist_C_SetupAbility final
{
public:
...
static_assert(alignof(GA_Commando_Survivalist_C_SetupAbility) == 0x000061, "Wrong alignment on GA_Commando_Survivalist_C_SetupAbility");
static_assert(sizeof(GA_Commando_Survivalist_C_SetupAbility) == 0x000061, "Wrong size on GA_Commando_Survivalist_C_SetupAbility");
...
static_assert(alignof(GA_Commando_Survivalist_C_K2_ShouldAbilityRespondToEvent) == 0x11822200, "Wrong alignment on GA_Commando_Survivalist_C_K2_ShouldAbilityRespondToEvent");
static_assert(sizeof(GA_Commando_Survivalist_C_K2_ShouldAbilityRespondToEvent) == 0x11822200, "Wrong size on GA_Commando_Survivalist_C_K2_ShouldAbilityRespondToEvent");
