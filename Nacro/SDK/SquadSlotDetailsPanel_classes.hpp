...
static_assert(alignof(USquadSlotDetailsPanel_C) == 0x322CBBB8, "Wrong alignment on USquadSlotDetailsPanel_C");
static_assert(sizeof(USquadSlotDetailsPanel_C) == 0x322CBBB8, "Wrong size on USquadSlotDetailsPanel_C");
