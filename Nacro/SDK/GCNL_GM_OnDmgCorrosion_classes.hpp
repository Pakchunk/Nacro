...
static_assert(alignof(AGCNL_GM_OnDmgCorrosion_C) == 0x11821D80, "Wrong alignment on AGCNL_GM_OnDmgCorrosion_C");
static_assert(sizeof(AGCNL_GM_OnDmgCorrosion_C) == 0x11821D80, "Wrong size on AGCNL_GM_OnDmgCorrosion_C");
