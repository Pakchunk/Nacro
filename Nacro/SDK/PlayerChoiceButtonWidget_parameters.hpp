...
public:
	...
	struct FChoiceDataEntry                       K2Node_CustomEvent_Choice;                         // 0x0008(0x11821780)()
...
static_assert(alignof(PlayerChoiceButtonWidget_C_ExecuteUbergraph_PlayerChoiceButtonWidget) == 0x11821780, "Wrong alignment on PlayerChoiceButtonWidget_C_ExecuteUbergraph_PlayerChoiceButtonWidget");
static_assert(sizeof(PlayerChoiceButtonWidget_C_ExecuteUbergraph_PlayerChoiceButtonWidget) == 0x11821780, "Wrong size on PlayerChoiceButtonWidget_C_ExecuteUbergraph_PlayerChoiceButtonWidget");
...
// 0xAB0616 (0xAB0616 - 0x0000)
struct alignas(0xAB0616) PlayerChoiceButtonWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_98_FortBaseButtonClicked__DelegateSignature final
{
public:
	class UFortBaseButton*                        Button_0;                                          // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PlayerChoiceButtonWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_98_FortBaseButtonClicked__DelegateSignature) == 0xAB0616, "Wrong alignment on PlayerChoiceButtonWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_98_FortBaseButtonClicked__DelegateSignature");
static_assert(sizeof(PlayerChoiceButtonWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_98_FortBaseButtonClicked__DelegateSignature) == 0xAB0616, "Wrong size on PlayerChoiceButtonWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_98_FortBaseButtonClicked__DelegateSignature");
...
// 0x62A9F280 (0x62A9F280 - 0x0000)
struct alignas(0x62A9F280) PlayerChoiceButtonWidget_C_ConfigureChoice final
{
public:
	struct FChoiceDataEntry                       Choice;                                            // 0x0000(0x11821780)(Parm)
...
static_assert(alignof(PlayerChoiceButtonWidget_C_ConfigureChoice) == 0x62A9F280, "Wrong alignment on PlayerChoiceButtonWidget_C_ConfigureChoice");
static_assert(sizeof(PlayerChoiceButtonWidget_C_ConfigureChoice) == 0x62A9F280, "Wrong size on PlayerChoiceButtonWidget_C_ConfigureChoice");
