...
public:
	...
	struct FKey                                   K2Node_CustomEvent_ButtonPressed;                  // 0x0010(0x11821D80)(HasGetValueTypeHash)
...
static_assert(alignof(WM_Pin_Master_C_ExecuteUbergraph_WM_Pin_Master) == 0x11821D80, "Wrong alignment on WM_Pin_Master_C_ExecuteUbergraph_WM_Pin_Master");
static_assert(sizeof(WM_Pin_Master_C_ExecuteUbergraph_WM_Pin_Master) == 0x11821D80, "Wrong size on WM_Pin_Master_C_ExecuteUbergraph_WM_Pin_Master");
...
struct alignas(0x30005F) WM_Pin_Master_C_HandleOnEndCursorOver final
{
public:
	class AActor*                                 TouchedActor;                                      // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WM_Pin_Master_C_HandleOnEndCursorOver) == 0x30005F, "Wrong alignment on WM_Pin_Master_C_HandleOnEndCursorOver");
static_assert(sizeof(WM_Pin_Master_C_HandleOnEndCursorOver) == 0x30005F, "Wrong size on WM_Pin_Master_C_HandleOnEndCursorOver");
...
public:
	class AActor*                                 TouchedActor;                                      // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FKey                                   ButtonPressed;                                     // 0x0008(0x11821D80)(Parm, HasGetValueTypeHash)
};
static_assert(alignof(WM_Pin_Master_C_HandleOnClicked) == 0x11821D80, "Wrong alignment on WM_Pin_Master_C_HandleOnClicked");
static_assert(sizeof(WM_Pin_Master_C_HandleOnClicked) == 0x11821D80, "Wrong size on WM_Pin_Master_C_HandleOnClicked");
...
struct alignas(0x460065) WM_Pin_Master_C_UserConstructionScript final
{
public:
...
static_assert(alignof(WM_Pin_Master_C_UserConstructionScript) == 0x460065, "Wrong alignment on WM_Pin_Master_C_UserConstructionScript");
static_assert(sizeof(WM_Pin_Master_C_UserConstructionScript) == 0x460065, "Wrong size on WM_Pin_Master_C_UserConstructionScript");
...
// 0x6ECC9E90 (0x6ECC9E90 - 0x0000)
struct alignas(0x6ECC9E90) WM_Pin_Master_C_IsLeader final
{
public:
...
static_assert(alignof(WM_Pin_Master_C_IsLeader) == 0x6ECC9E90, "Wrong alignment on WM_Pin_Master_C_IsLeader");
static_assert(sizeof(WM_Pin_Master_C_IsLeader) == 0x6ECC9E90, "Wrong size on WM_Pin_Master_C_IsLeader");
...
public:
	...
	struct FFortTheaterMapData                    CallFunc_GetTheaterData_OutTheaterData;            // 0x0010(0x11821780)()
...
static_assert(alignof(WM_Pin_Master_C_CanAccessPin) == 0x11821780, "Wrong alignment on WM_Pin_Master_C_CanAccessPin");
static_assert(sizeof(WM_Pin_Master_C_CanAccessPin) == 0x11821780, "Wrong size on WM_Pin_Master_C_CanAccessPin");
...
public:
	...
	struct FFortTheaterMapData                    CallFunc_GetTheaterData_OutTheaterData;            // 0x0028(0x11821780)()
...
static_assert(alignof(WM_Pin_Master_C_GetRequiredText) == 0x11821780, "Wrong alignment on WM_Pin_Master_C_GetRequiredText");
static_assert(sizeof(WM_Pin_Master_C_GetRequiredText) == 0x11821780, "Wrong size on WM_Pin_Master_C_GetRequiredText");
...
struct alignas(0x730061) WM_Pin_Master_C_UpdateVisuals final
{
public:
	bool                                          CallFunc_CanAccessPin_Accessible;                  // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(WM_Pin_Master_C_UpdateVisuals) == 0x730061, "Wrong alignment on WM_Pin_Master_C_UpdateVisuals");
static_assert(sizeof(WM_Pin_Master_C_UpdateVisuals) == 0x730061, "Wrong size on WM_Pin_Master_C_UpdateVisuals");
...
// 0x620075 (0x620075 - 0x0000)
struct alignas(0x620075) WM_Pin_Master_C_InitializeContextEvents final
{
public:
...
static_assert(alignof(WM_Pin_Master_C_InitializeContextEvents) == 0x620075, "Wrong alignment on WM_Pin_Master_C_InitializeContextEvents");
static_assert(sizeof(WM_Pin_Master_C_InitializeContextEvents) == 0x620075, "Wrong size on WM_Pin_Master_C_InitializeContextEvents");
...
// 0x460065 (0x460065 - 0x0000)
struct alignas(0x460065) WM_Pin_Master_C_OnTheaterSelected final
{
public:
	class FString                                 TheaterId_0;                                       // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(WM_Pin_Master_C_OnTheaterSelected) == 0x460065, "Wrong alignment on WM_Pin_Master_C_OnTheaterSelected");
static_assert(sizeof(WM_Pin_Master_C_OnTheaterSelected) == 0x460065, "Wrong size on WM_Pin_Master_C_OnTheaterSelected");
...
struct alignas(0x0A) WM_Pin_Master_C_UpdateSelectionState final
{
public:
...
static_assert(alignof(WM_Pin_Master_C_UpdateSelectionState) == 0x00000A, "Wrong alignment on WM_Pin_Master_C_UpdateSelectionState");
static_assert(sizeof(WM_Pin_Master_C_UpdateSelectionState) == 0x00000A, "Wrong size on WM_Pin_Master_C_UpdateSelectionState");
