...
static_assert(alignof(UCircleAroundPrimaryAssignmentGoals_Blaster_C) == 0x11821780, "Wrong alignment on UCircleAroundPrimaryAssignmentGoals_Blaster_C");
static_assert(sizeof(UCircleAroundPrimaryAssignmentGoals_Blaster_C) == 0x11821780, "Wrong size on UCircleAroundPrimaryAssignmentGoals_Blaster_C");
