...
static_assert(alignof(UGCNS_GM_PlayerOnDmgLifeLeech_C) == 0x11821D80, "Wrong alignment on UGCNS_GM_PlayerOnDmgLifeLeech_C");
static_assert(sizeof(UGCNS_GM_PlayerOnDmgLifeLeech_C) == 0x11821D80, "Wrong size on UGCNS_GM_PlayerOnDmgLifeLeech_C");
