...
public:
	...
	struct FUniqueNetIdRepl                       K2Node_CustomEvent_UniqueId;                       // 0x0020(0x11821780)(ConstParm, HasGetValueTypeHash)
};
static_assert(alignof(PowerRequirement_C_ExecuteUbergraph_PowerRequirement) == 0x11821780, "Wrong alignment on PowerRequirement_C_ExecuteUbergraph_PowerRequirement");
static_assert(sizeof(PowerRequirement_C_ExecuteUbergraph_PowerRequirement) == 0x11821780, "Wrong size on PowerRequirement_C_ExecuteUbergraph_PowerRequirement");
...
{
public:
	struct FUniqueNetIdRepl                       UniqueId;                                          // 0x0000(0x11821780)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
static_assert(alignof(PowerRequirement_C_PlayerInfoChanged) == 0x11821780, "Wrong alignment on PowerRequirement_C_PlayerInfoChanged");
static_assert(sizeof(PowerRequirement_C_PlayerInfoChanged) == 0x11821780, "Wrong size on PowerRequirement_C_PlayerInfoChanged");
...
struct alignas(0x56005F) PowerRequirement_C_SetRequirements final
{
public:
...
static_assert(alignof(PowerRequirement_C_SetRequirements) == 0x56005F, "Wrong alignment on PowerRequirement_C_SetRequirements");
static_assert(sizeof(PowerRequirement_C_SetRequirements) == 0x56005F, "Wrong size on PowerRequirement_C_SetRequirements");
...
public:
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUniqueID_ReturnValue;                  // 0x0020(0x11821780)(HasGetValueTypeHash)
...
static_assert(alignof(PowerRequirement_C_Update) == 0x11821780, "Wrong alignment on PowerRequirement_C_Update");
static_assert(sizeof(PowerRequirement_C_Update) == 0x11821780, "Wrong size on PowerRequirement_C_Update");
...
static_assert(alignof(PowerRequirement_C_SetUIForRecommended) == 0x322CBBB8, "Wrong alignment on PowerRequirement_C_SetUIForRecommended");
static_assert(sizeof(PowerRequirement_C_SetUIForRecommended) == 0x322CBBB8, "Wrong size on PowerRequirement_C_SetUIForRecommended");
...
static_assert(alignof(PowerRequirement_C_SetUIForRequired) == 0x322CBBB8, "Wrong alignment on PowerRequirement_C_SetUIForRequired");
static_assert(sizeof(PowerRequirement_C_SetUIForRequired) == 0x322CBBB8, "Wrong size on PowerRequirement_C_SetUIForRequired");
...
struct alignas(0x53005F) PowerRequirement_C_GenerateToolTipWidget final
{
public:
...
static_assert(alignof(PowerRequirement_C_GenerateToolTipWidget) == 0x53005F, "Wrong alignment on PowerRequirement_C_GenerateToolTipWidget");
static_assert(sizeof(PowerRequirement_C_GenerateToolTipWidget) == 0x53005F, "Wrong size on PowerRequirement_C_GenerateToolTipWidget");
