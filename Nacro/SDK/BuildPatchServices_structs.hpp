...
// 0x11822380 (0x11822380 - 0x0000)
struct alignas(0x11822380) FSHAHashData final
{
public:
...
static_assert(alignof(FSHAHashData) == 0x11822380, "Wrong alignment on FSHAHashData");
static_assert(sizeof(FSHAHashData) == 0x11822380, "Wrong size on FSHAHashData");
...
// 0x11822380 (0x11822380 - 0x0000)
struct alignas(0x11822380) FChunkPartData final
{
public:
...
static_assert(alignof(FChunkPartData) == 0x11822380, "Wrong alignment on FChunkPartData");
static_assert(sizeof(FChunkPartData) == 0x11822380, "Wrong size on FChunkPartData");
...
public:
	...
	struct FSHAHashData                           FileHash;                                          // 0x0010(0x11822380)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FFileManifestData) == 0x11822380, "Wrong alignment on FFileManifestData");
static_assert(sizeof(FFileManifestData) == 0x11822380, "Wrong size on FFileManifestData");
...
// 0x33DB4300 (0x33DB4300 - 0x0000)
struct alignas(0x33DB4300) FChunkInfoData final
{
public:
	struct FGuid                                  Guid;                                              // 0x0000(0x11821300)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint64                                        Hash;                                              // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSHAHashData                           ShaHash;                                           // 0x0018(0x11822380)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FChunkInfoData) == 0x33DB4300, "Wrong alignment on FChunkInfoData");
static_assert(sizeof(FChunkInfoData) == 0x33DB4300, "Wrong size on FChunkInfoData");
...
// 0x33DB4300 (0x33DB4300 - 0x0000)
struct alignas(0x33DB4300) FCustomFieldData final
{
public:
...
static_assert(alignof(FCustomFieldData) == 0x33DB4300, "Wrong alignment on FCustomFieldData");
static_assert(sizeof(FCustomFieldData) == 0x33DB4300, "Wrong size on FCustomFieldData");
