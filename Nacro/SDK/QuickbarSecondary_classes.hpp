...
static_assert(offsetof(UQuickbarSecondary_C, mHorizontal_Box__Camera_Mode_Content) == 0x000290, "Member 'UQuickbarSecondary_C::mHorizontal_Box__Camera_Mode_Content' has a wrong offset!");
static_assert(offsetof(UQuickbarSecondary_C, mImage__Separator) == 0x000298, "Member 'UQuickbarSecondary_C::mImage__Separator' has a wrong offset!");
static_assert(offsetof(UQuickbarSecondary_C, mImage__Switch_Action) == 0x0002A0, "Member 'UQuickbarSecondary_C::mImage__Switch_Action' has a wrong offset!");
