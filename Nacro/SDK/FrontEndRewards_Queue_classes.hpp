...
public:
	...
	struct FTimerHandle                           IconSlideHandle;                                   // 0x0270(0x11821D80)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	struct FTimerHandle                           IconInitHandle;                                    // 0x0280(0x11821D80)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(alignof(UFrontEndRewards_Queue_C) == 0x322CBBB8, "Wrong alignment on UFrontEndRewards_Queue_C");
static_assert(sizeof(UFrontEndRewards_Queue_C) == 0x322CBBB8, "Wrong size on UFrontEndRewards_Queue_C");
