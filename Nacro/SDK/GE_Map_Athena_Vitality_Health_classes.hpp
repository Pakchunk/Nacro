...
static_assert(alignof(UGE_Map_Athena_Vitality_Health_C) == 0x1182E980, "Wrong alignment on UGE_Map_Athena_Vitality_Health_C");
static_assert(sizeof(UGE_Map_Athena_Vitality_Health_C) == 0x1182E980, "Wrong size on UGE_Map_Athena_Vitality_Health_C");
