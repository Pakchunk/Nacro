...
static_assert(alignof(UTeamID_Orange_C) == 0x11821300, "Wrong alignment on UTeamID_Orange_C");
static_assert(sizeof(UTeamID_Orange_C) == 0x11821300, "Wrong size on UTeamID_Orange_C");
