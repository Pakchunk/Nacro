...
struct alignas(0x56005F) MissionAlertIndicator_C_ExecuteUbergraph_MissionAlertIndicator final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(MissionAlertIndicator_C_ExecuteUbergraph_MissionAlertIndicator) == 0x56005F, "Wrong alignment on MissionAlertIndicator_C_ExecuteUbergraph_MissionAlertIndicator");
static_assert(sizeof(MissionAlertIndicator_C_ExecuteUbergraph_MissionAlertIndicator) == 0x56005F, "Wrong size on MissionAlertIndicator_C_ExecuteUbergraph_MissionAlertIndicator");
...
static_assert(alignof(MissionAlertIndicator_C_ToggleTimer) == 0x11821D80, "Wrong alignment on MissionAlertIndicator_C_ToggleTimer");
static_assert(sizeof(MissionAlertIndicator_C_ToggleTimer) == 0x11821D80, "Wrong size on MissionAlertIndicator_C_ToggleTimer");
