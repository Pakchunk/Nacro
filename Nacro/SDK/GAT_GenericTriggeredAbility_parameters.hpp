...
public:
	...
	struct FGameplayAbilityActorInfo              CallFunc_GetActorInfo_ReturnValue;                 // 0x0008(0x11821C00)(ContainsInstancedReference)
	...
	struct FGameplayEventData                     K2Node_MakeStruct_GameplayEventData;               // 0x0058(0x11822200)()
	struct FGameplayAbilityTargetDataHandle       CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x0100(0x11821C00)()
	...
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x0130(0x11822200)(ConstParm)
};
static_assert(alignof(GAT_GenericTriggeredAbility_C_ExecuteUbergraph_GAT_GenericTriggeredAbility) == 0x11822200, "Wrong alignment on GAT_GenericTriggeredAbility_C_ExecuteUbergraph_GAT_GenericTriggeredAbility");
static_assert(sizeof(GAT_GenericTriggeredAbility_C_ExecuteUbergraph_GAT_GenericTriggeredAbility) == 0x11822200, "Wrong size on GAT_GenericTriggeredAbility_C_ExecuteUbergraph_GAT_GenericTriggeredAbility");
...
static_assert(alignof(GAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong alignment on GAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent");
static_assert(sizeof(GAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent) == 0x11822200, "Wrong size on GAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent");
