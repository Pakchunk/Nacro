...
static_assert(alignof(AGCN_NPC_Ice_C) == 0x11821D80, "Wrong alignment on AGCN_NPC_Ice_C");
static_assert(sizeof(AGCN_NPC_Ice_C) == 0x11821D80, "Wrong size on AGCN_NPC_Ice_C");
