...
static_assert(alignof(UArrowCursorWidget_C) == 0x322CBBB8, "Wrong alignment on UArrowCursorWidget_C");
static_assert(sizeof(UArrowCursorWidget_C) == 0x322CBBB8, "Wrong size on UArrowCursorWidget_C");
