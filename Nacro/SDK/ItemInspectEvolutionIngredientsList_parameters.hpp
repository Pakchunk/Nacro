...
public:
	...
	struct FFortItemQuantityPair                  CallFunc_Array_Get_Item;                           // 0x0030(0x52535)()
...
static_assert(alignof(ItemInspectEvolutionIngredientsList_C_SetIngredients) == 0x052535, "Wrong alignment on ItemInspectEvolutionIngredientsList_C_SetIngredients");
static_assert(sizeof(ItemInspectEvolutionIngredientsList_C_SetIngredients) == 0x052535, "Wrong size on ItemInspectEvolutionIngredientsList_C_SetIngredients");
...
// 0x6858AA00 (0x6858AA00 - 0x0000)
struct alignas(0x6858AA00) ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement final
{
public:
	class UFortItem*                              Item;                                              // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FSlateColor                            K2Node_Select_Default;                             // 0x00F8(0x322CBBB8)()
};
static_assert(alignof(ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement) == 0x6858AA00, "Wrong alignment on ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement");
static_assert(sizeof(ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement) == 0x6858AA00, "Wrong size on ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement");
