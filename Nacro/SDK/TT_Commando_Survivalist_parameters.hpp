...
struct alignas(0x38) TT_Commando_Survivalist_C_ConvertSurvivalistHealthIntoModifiedHealth final
{
public:
...
static_assert(alignof(TT_Commando_Survivalist_C_ConvertSurvivalistHealthIntoModifiedHealth) == 0x000038, "Wrong alignment on TT_Commando_Survivalist_C_ConvertSurvivalistHealthIntoModifiedHealth");
static_assert(sizeof(TT_Commando_Survivalist_C_ConvertSurvivalistHealthIntoModifiedHealth) == 0x000038, "Wrong size on TT_Commando_Survivalist_C_ConvertSurvivalistHealthIntoModifiedHealth");
...
public:
	const class UGameplayAbility*                 AbilityInstance;                                   // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           Tag;                                               // 0x0008(0x11821D80)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayTag                           Token;                                             // 0x0018(0x11821D80)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
	...
	struct FFortBaseWeaponStats                   CallFunc_GetDataTableRowFromName_OutRow;           // 0x0058(0x11821780)()
...
static_assert(alignof(TT_Commando_Survivalist_C_GetTextForTokenFromAbilityInstanceInternal) == 0x11821D80, "Wrong alignment on TT_Commando_Survivalist_C_GetTextForTokenFromAbilityInstanceInternal");
static_assert(sizeof(TT_Commando_Survivalist_C_GetTextForTokenFromAbilityInstanceInternal) == 0x11821D80, "Wrong size on TT_Commando_Survivalist_C_GetTextForTokenFromAbilityInstanceInternal");
